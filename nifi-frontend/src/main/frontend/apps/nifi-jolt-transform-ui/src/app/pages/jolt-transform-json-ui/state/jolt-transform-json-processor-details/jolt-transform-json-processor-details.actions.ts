...
export const resetJoltTransformJsonProcessorDetailsState = createAction(
    `${JOLT_TRANSFORM_JSON_PROCESSOR_DETAILS_PREFIX} Reset Jolt Transform Json Processor Details State`
);
...
export const loadProcessorDetailsSuccess = createAction(
    `${JOLT_TRANSFORM_JSON_PROCESSOR_DETAILS_PREFIX} Load Processor Details Success`,

...
describe('MultiProcessorUseCaseComponent', () => {
    ...
    let fixture: ComponentFixture<MultiProcessorUseCaseComponent>;

    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [MultiProcessorUseCaseComponent],
            providers: [
                provideMockStore({
                    initialState: {
        ...
        fixture = TestBed.createComponent(MultiProcessorUseCaseComponent);

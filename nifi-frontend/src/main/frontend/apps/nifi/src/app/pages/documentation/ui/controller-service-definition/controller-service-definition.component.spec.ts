...
import { ControllerServiceDefinition } from './controller-service-definition.component';
...
describe('ControllerServiceDefinition', () => {
    ...
    let fixture: ComponentFixture<ControllerServiceDefinition>;

    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [ControllerServiceDefinition],
            providers: [
                provideMockStore({
                    initialState: {
        ...
        fixture = TestBed.createComponent(ControllerServiceDefinition);

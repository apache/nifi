...
import { CloseOnEscapeDialog, CopyDirective, NifiSpinnerDirective, NifiTooltipDirective, TextTip } from '@nifi/shared';
...
import { remoteProcessGroupSupportsModification } from '../../utils/component-state.utils';
...
export class EditRemoteProcessGroup extends CloseOnEscapeDialog {
    ...
    constructor() {
        ...
        this.readonly = !request.entity.permissions.canWrite || !remoteProcessGroupSupportsModification(request.entity);

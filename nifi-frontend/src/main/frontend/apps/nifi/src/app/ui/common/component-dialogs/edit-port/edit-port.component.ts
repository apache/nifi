...
export class EditPort extends CloseOnEscapeDialog {
    ...
    @Output() editPort: EventEmitter<UpdateComponentRequest> = new EventEmitter<UpdateComponentRequest>();
    ...
    constructor() {
        ...
        this.readonly = !request.entity.permissions.canWrite || !runnableSupportsModification(request.entity);

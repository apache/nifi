...
import { HexViewer } from './hex-viewer.component';
...
describe('HexViewer', () => {
    let component: HexViewer;
    let fixture: ComponentFixture<HexViewer>;

    beforeEach(() => {
        TestBed.configureTestingModule({
            imports: [HexViewer, HttpClientTestingModule],
            providers: [
                provideMockStore({
                    initialState: {
        ...
        fixture = TestBed.createComponent(HexViewer);

...
import { ProcessorDefinition } from './processor-definition.component';
...
describe('ProcessorDefinition', () => {
    ...
    let fixture: ComponentFixture<ProcessorDefinition>;

    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [ProcessorDefinition],
            providers: [
                provideMockStore({
                    initialState: {
        ...
        fixture = TestBed.createComponent(ProcessorDefinition);

...
describe('EditProcessor', () => {
    ...
    it('should enable concurrent tasks when supportsParallelProcessing is true', () => {
        const concurrentTasks = component.editProcessorForm.get('concurrentTasks');
        expect(concurrentTasks?.enabled).toBe(true);
    });

    it('should return standard tooltip when supportsParallelProcessing is true', () => {
...
describe('EditProcessor with TriggerSerially', () => {
    ...
    const serialData: EditComponentDialogRequest = JSON.parse(JSON.stringify(data));
    ...
    it('should disable concurrent tasks when supportsParallelProcessing is false', () => {
        const concurrentTasks = component.editProcessorForm.get('concurrentTasks');

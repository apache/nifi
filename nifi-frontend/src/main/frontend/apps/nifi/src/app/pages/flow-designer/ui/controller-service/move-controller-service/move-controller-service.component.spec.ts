...
describe('MoveControllerService', () => {
    ...
    const options = [
        {
            text: 'pg2',
            value: 'bae2ec98-0192-1000-504b-6bf6ce039f24',
            description:
                'Could not move controller service because the following components would be out of scope: [FetchGridFS]',
            disabled: true
        },
        {
            text: 'pg1',
            value: 'bad208f8-0192-1000-a9b3-3bc0d208b78b',
            description:
                'Could not move controller service because the following components would be out of scope: [FetchGridFS]',
            disabled: true
        }

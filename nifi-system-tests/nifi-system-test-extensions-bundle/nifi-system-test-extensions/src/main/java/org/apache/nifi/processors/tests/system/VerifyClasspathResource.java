...
public class VerifyClasspathResource extends AbstractProcessor implements VerifiableProcessor {
    ...
    private final AtomicInteger connectorMethodInvocationCount = new AtomicInteger();
    ...
    @ConnectorMethod(
            ...
            description = "Increments and returns the number of invocations on this Processor instance",
            allowedStates = {ComponentState.STOPPED, ComponentState.PROCESSOR_DISABLED}
    )

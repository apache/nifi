...
public class EnsureFlowAnalysisRuleConfigurationCorrect extends AbstractFlowAnalysisRule implements VerifiableFlowAnalysisRule {
    ...
    public List<ConfigVerificationResult> verify(final ConfigurationContext context, final ComponentLog verificationLogger) {
        ...
        if (exception) {
            throw new RuntimeException("Intentional Exception - Component was configured to throw an Exception when performing config verification");
        }

...
public class NodeConnectorStatusSnapshotDTO implements Cloneable {
    ...
    public void setStatusSnapshot(final ConnectorStatusSnapshotDTO statusSnapshot) {
        this.statusSnapshot = statusSnapshot;
    }

    @Override
    public NodeConnectorStatusSnapshotDTO clone() {
        final NodeConnectorStatusSnapshotDTO other = new NodeConnectorStatusSnapshotDTO();

...
/**
 * Initializes a FlowAnalysisRule using a MockFlowAnalysisRuleInitializationContext;
 */
public class FlowAnalysisRuleInitializer implements ConfigurableComponentInitializer {

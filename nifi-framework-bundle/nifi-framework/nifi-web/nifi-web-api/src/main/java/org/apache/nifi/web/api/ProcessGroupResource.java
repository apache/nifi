...
public class ProcessGroupResource extends FlowUpdateResource<ProcessGroupImportEntity, ProcessGroupReplaceRequestEntity> {
    ...
    public Response exportProcessGroup(
        ...
        if (includeReferencedServices) {
            filenameSuffix = "_with_services";  // Appending "_with_services" if services are included
        }
        final String flowName = currentVersionedProcessGroup.getName() + filenameSuffix;

...
public class PrometheusMetricsUtil {
    ...
    versionInfoRegistry.setDataPoint(1, "NIFI_VERSION_INFO",instanceId,details.nifiVersion,details.javaVersion,details.revision,details.tag,details.osName,details.osVersion); 
}

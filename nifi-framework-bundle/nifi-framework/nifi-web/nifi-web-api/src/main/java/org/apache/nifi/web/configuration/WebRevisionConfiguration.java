...
/**
 * Web Revision Configuration stands alone to support Revision Manager integration with framework and web components
 */
@Configuration
public class WebRevisionConfiguration {
    /**
     * Revision Manager required for integration with Flow Controller operations
     *

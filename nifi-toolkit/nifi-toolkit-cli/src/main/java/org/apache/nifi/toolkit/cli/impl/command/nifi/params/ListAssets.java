...
public class ListAssets extends AbstractNiFiCommand<AssetsResult> {
    ...
    @Override
    public AssetsResult doExecute(final NiFiClient client, final Properties properties)
        ...
        final AssetsEntity assetsEntity = paramContextClient.getAssets(paramContextId);
        return new AssetsResult(getResultType(properties), assetsEntity);
    }
}

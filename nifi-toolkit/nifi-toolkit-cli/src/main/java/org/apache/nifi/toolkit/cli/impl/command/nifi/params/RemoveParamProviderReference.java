...
public class RemoveParamProviderReference extends AbstractUpdateParamContextCommand<VoidResult> {

    public RemoveParamProviderReference() {
        super("remove-param-provider-reference", VoidResult.class);
    }

    @Override
    public String getDescription() {
        return "Removes a referenced parameter provider from a parameter context";
    }
    ...
    public VoidResult doExecute(final NiFiClient client, final Properties properties)
        ...
        // Now make the update
        if (sensitive) {
            parameterContextDTO.setSensitiveParameterProviderRef(null);
        } else {
            parameterContextDTO.setNonSensitiveParameterProviderRef(null);
        }

...
public class GetControllerConfiguration extends AbstractNiFiCommand<ControllerConfigurationResult> {
    public GetControllerConfiguration() {
        super("get-controller-configuration", ControllerConfigurationResult.class);
    }
    ...
    public ControllerConfigurationResult doExecute(final NiFiClient client, final Properties properties) throws NiFiClientException, IOException, MissingOptionException, CommandException {
        ...
        final ControllerConfigurationEntity controllerConfigurationEntity = controllerClient.getControllerConfiguration();
        return new ControllerConfigurationResult(getResultType(properties), controllerConfigurationEntity);
    }
}

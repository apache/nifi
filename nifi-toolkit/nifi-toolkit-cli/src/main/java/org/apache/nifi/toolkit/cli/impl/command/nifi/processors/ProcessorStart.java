...
/**
 * Command to start a processor (or execute a run once on a processor)
 */
public class ProcessorStart extends AbstractNiFiCommand<ProcessorResult> {
    ...
    public String getDescription() {
        return "Starts a processor. Can also be used to execute a Run Once on a processor with the corresponding flag.";
    }
    ...
    public ProcessorResult doExecute(NiFiClient client, Properties properties)
        ...
        final boolean runOnce = properties.containsKey(CommandOption.RUN_ONCE.getLongName());
        ...
        final ProcessorEntity result = runOnce ? processorClient.runProcessorOnce(processor) : processorClient.startProcessor(processor);

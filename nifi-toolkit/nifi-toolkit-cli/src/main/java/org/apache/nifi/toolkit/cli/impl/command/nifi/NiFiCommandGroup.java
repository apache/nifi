...
import org.apache.nifi.toolkit.cli.impl.command.nifi.params.RemoveParamProviderReference;
...
import org.apache.nifi.toolkit.cli.impl.command.nifi.params.SetParamProviderReference;
...
public class NiFiCommandGroup extends AbstractCommandGroup {
    ...
    protected List<Command> createCommands() {
        ...
        commands.add(new SetParamProviderReference());
        commands.add(new RemoveParamProviderReference());

...
import org.apache.nifi.console.subcommands.Flow;
import picocli.CommandLine;

@CommandLine.Command(name="PropertyEncryptor",
        usageHelpWidth=140,
        subcommands = { Config.class, Flow.class }
)
class PropertyEncryptorCLI implements Runnable {
    ...
    @Override
    public void run() {
        if (genericOptions.verboseLogging) {

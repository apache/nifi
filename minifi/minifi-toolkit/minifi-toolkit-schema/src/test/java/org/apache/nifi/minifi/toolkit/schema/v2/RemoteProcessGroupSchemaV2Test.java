...
public class RemoteProcessGroupSchemaV2Test {
    ...
    public void testTransportProtocol() {
        ...
        final RemoteProcessGroupSchemaV2 first =  new RemoteProcessGroupSchemaV2(map);
        ...
        final RemoteProcessGroupSchemaV2 second =  new RemoteProcessGroupSchemaV2(map);
    ...
    private void validateIssuesNumMatches(final int expected, final RemoteProcessGroupSchemaV2 remoteProcessGroupSchema) {

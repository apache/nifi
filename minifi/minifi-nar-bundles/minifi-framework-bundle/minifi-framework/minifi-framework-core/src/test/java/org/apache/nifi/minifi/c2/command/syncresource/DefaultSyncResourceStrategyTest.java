...
public class DefaultSyncResourceStrategyTest {
    ...
    public void testAddingNewItems() {
        final List<ResourceItem> c2Items = List.of(
        ...
        final OperationState resultState =
    ...
    public void testAddingNewItemWhenBinaryPresent() {
        final ResourceItem resourceItem = resourceItem("resource1", "url1", null, ASSET);
        when(mockResourceRepository.findAllResourceItems()).thenReturn(List.of());
        when(mockResourceRepository.saveResourcesGlobalHash(C2_GLOBAL_HASH)).thenReturn(Optional.of(C2_GLOBAL_HASH));
    ...
    public void testAddingNewItemsSuccessWithValidResourcePath(final String validResourcePath) {
        final List<ResourceItem> c2Items = List.of(
    ...
    public void testAddingNewItemFailureWhenTypeIsAssetAndPathIsInvalid(final String invalidResourcePath) {
        final List<ResourceItem> c2Items = List.of(
    ...
    public void testAddingNewItemFailureDueToIssueWhenUpdatingRepository() {
        final ResourceItem resourceItem = resourceItem("resource1", "url1", null, ASSET);
        final List<ResourceItem> c2Items = List.of(resourceItem);
        when(mockResourceRepository.findAllResourceItems()).thenReturn(List.of());
        try {
    ...
    public void testDeletingAllItems() {
        final List<ResourceItem> c2Items = List.of();
        final List<ResourceItem> agentItems = List.of(
            resourceItem("resource1", "url1", null, ASSET),
    ...
    public void testAddFileSuccessfulButUpdateGlobalHashFails() {
        final ResourceItem c2Item = resourceItem("resource1", "url1", null, ASSET);
        when(mockResourceRepository.findAllResourceItems()).thenReturn(List.of());
        try {
    ...
    private static ResourcesGlobalHash resourcesGlobalHash(final String digest) {
    ...
    private ResourceItem resourceItem(final String name, final String url, final String path, final ResourceType resourceType) {

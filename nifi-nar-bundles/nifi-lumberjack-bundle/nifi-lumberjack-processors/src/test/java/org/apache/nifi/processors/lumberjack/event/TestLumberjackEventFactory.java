...
public class TestLumberjackEventFactory {
    ...
    public void testCreateLumberJackEvent() {
        ...
        final String file = "/var/log/test_file";
        ...
        metadata.put(LumberjackMetadata.FILE_KEY, file);
        metadata.put(LumberjackMetadata.OFFSET_KEY, offset);
        ...
        Assert.assertEquals(file, event.getFile());
        Assert.assertEquals(offset, event.getOffset());

...
public class AbstractXMPPProcessorTest {
    ...
    public void whenConnectionFails_theExceptionHasTheCorrectMessage() {
        ...
        assertThat(exception.getMessage(), is("Failed to connect to the XMPP server: " + XMPPClientSpy.CONNECT_ERROR_MESSAGE));
    }
    ...
    public void whenLoginFails_theExceptionHasTheCorrectMessage() {
        ...
        assertThat(exception.getMessage(), is("Failed to login to the XMPP server: " + XMPPClientSpy.LOGIN_ERROR_MESSAGE));
    }
    ...
    private static class TestableStandardSSLContextService extends StandardSSLContextService {
        ...
        @Override
        public SSLContext createSSLContext(ClientAuth clientAuth) {
            return sslContext;
        }
    }
}

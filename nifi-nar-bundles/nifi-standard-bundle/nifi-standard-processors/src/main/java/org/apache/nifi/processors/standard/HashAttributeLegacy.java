...
@CapabilityDescription("Hashes together the key/value pairs of several FlowFile Attributes and adds the hash as a new attribute. "
        ...
        + "group will be used. " + "For a processor which accepts various attributes and generates a cryptographic hash of each, see \"HashAttribute\". ")
...
public class HashAttributeLegacy extends AbstractProcessor {

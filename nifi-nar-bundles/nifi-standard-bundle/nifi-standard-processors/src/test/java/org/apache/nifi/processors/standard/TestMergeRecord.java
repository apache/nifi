...
public class TestMergeRecord {
    ...
    public void testMergeWithMinRecordsFromVariableRegistry() {
        runner.setEnvironmentSystemVariableValue("min_records", "3");
        runner.setEnvironmentSystemVariableValue("max_records", "3");
    ...
    public void testNegativeMinAndMaxRecordsValidators(){
        ...
        runner.setEnvironmentSystemVariableValue("min_records", "-3");
        runner.setEnvironmentSystemVariableValue("max_records", "-1");
        ...
        runner.setEnvironmentSystemVariableValue("min_records", "-1");
        runner.setEnvironmentSystemVariableValue("max_records", "-3");
        runner.setProperty(MergeRecord.MIN_RECORDS, "${min_records}");
        runner.setProperty(MergeRecord.MAX_RECORDS, "${max_records}");
        runner.assertNotValid();
        ...
        runner.setEnvironmentSystemVariableValue("min_records", "1");
        runner.setEnvironmentSystemVariableValue("max_records", "5");
        runner.setProperty(MergeRecord.MIN_RECORDS, "${min_records}");
        runner.setProperty(MergeRecord.MAX_RECORDS, "${max_records}");
        runner.assertValid();

...
public class TestListenHTTPAuthenticated {
    ...
    private final static String HTTP_LOGIN = "nifi" ;
    private final static String HTTP_PASSWORD = "nifi";
    ...
    public void setup() throws IOException {
        ...
        runner.setProperty(ListenHTTP.PROP_BASIC_AUTH_USERNAME, HTTP_LOGIN);
        runner.setProperty(ListenHTTP.PROP_BASIC_AUTH_PASSWORD, HTTP_PASSWORD);
    }
    ...
    private int executePOST(String message) throws Exception {
        ...
        String userpass = HTTP_LOGIN + ":" + HTTP_PASSWORD;

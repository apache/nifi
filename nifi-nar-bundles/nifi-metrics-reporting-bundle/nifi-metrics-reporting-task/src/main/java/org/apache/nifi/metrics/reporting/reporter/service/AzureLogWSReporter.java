...
public class AzureLogWSReporter extends ScheduledReporter {
     ...
     * @param logType Record type name
     ...
     * @param json original json data in string to send before computer column injected
     ...
     * @param contentLength data length to send

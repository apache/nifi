...
interface RegistryCommon {
     ...
     */
    static Schema retrieveSchemaViaDelegate(SchemaRegistry registryDelegate, InvocationContextProperties contextProperties) {
        String schemaName = contextProperties.getPropertyValue(SCHEMA_NAME, true);
        String schemaText = registryDelegate.retrieveSchemaText(schemaName);

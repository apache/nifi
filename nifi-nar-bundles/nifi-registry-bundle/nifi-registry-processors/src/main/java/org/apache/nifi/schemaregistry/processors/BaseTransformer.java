 ...
 * receive {@link FlowFile} and output {@link FlowFile} without modifying the
 * content of the {@link FlowFile}. This processors is best suited to implement
 * pro
 */
public abstract class BaseTransformer extends AbstractProcessor {
    ...
    protected static final Set<Relationship> BASE_RELATIONSHIPS;

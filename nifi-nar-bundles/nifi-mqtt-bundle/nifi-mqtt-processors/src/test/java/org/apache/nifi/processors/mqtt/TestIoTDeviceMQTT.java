...
import org.apache.nifi.processors.mqtt.common.TestIoTDeviceMqttCommon;
...
public class TestIoTDeviceMQTT extends TestIoTDeviceMqttCommon {

    public MqttTestClient mqttTestClient;

    public class UnitTestableIoTDeviceMQTT extends IoTDeviceMQTT {

        public UnitTestableIoTDeviceMQTT(){
            super();
        }
    ...
    public void init() throws IOException {
        ...
        UnitTestableIoTDeviceMQTT proc = new UnitTestableIoTDeviceMQTT();
        testRunner = TestRunners.newTestRunner(proc);
        testRunner.setProperty(IoTDeviceMQTT.PROP_BROKER_URI, broker);
        testRunner.setProperty(IoTDeviceMQTT.PROP_CLIENTID, "TestClient");
        testRunner.setProperty(IoTDeviceMQTT.PROP_TOPIC_FILTER, "testTopic");
        testRunner.setProperty(IoTDeviceMQTT.PROP_MAX_QUEUE_SIZE, "100");
        testRunner.setProperty(IoTDeviceMQTT.PROP_RETAIN, "false");
        testRunner.setProperty(IoTDeviceMQTT.PROP_TOPIC, "testTopic");
    ...
    public void testMessageNotConsumedOnCommitFail() throws NoSuchFieldException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        IoTDeviceMQTT processor = (IoTDeviceMQTT) testRunner.getProcessor();
    ...
    @Override
    public void internalPublish(PublishMessage publishMessage, ConnectType type) {
        ...
        try {
            mqttTestClient.publish(publishMessage.getTopicName(), mqttMessage, type);

...
public class TestFetchS3Object extends S3Setup {
    @Test
    public void testSimpleGet() throws IOException {
        ...
        runner.setProperty(FetchS3Object.KEY, key);

        final Map<String, String> attrs = new HashMap<>();
        attrs.put("filename", RESOURCE_NAME);
    ...
    public void testTryToFetchNotExistingFile() throws IOException {
        ...
        runner.setProperty(FetchS3Object.CREDENTAILS_FILE, CREDENTIALS_FILE);
        runner.setProperty(FetchS3Object.REGION, REGION);
        runner.setProperty(FetchS3Object.BUCKET, "no-such-a-key");
    ...
    public void testContentsOfFileRetrieved() throws IOException {
        ...
        final byte[] expectedBytes = Files.readAllBytes(getResourcePath(RESOURCE_NAME));

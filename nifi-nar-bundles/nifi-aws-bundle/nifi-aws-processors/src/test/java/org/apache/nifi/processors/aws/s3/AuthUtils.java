...
public class AuthUtils {
    public static void enableAccessKey(final TestRunner runner, final String accessKeyId, final String secretKey) {
        ...
        runner.setProperty(credentialsService, CredentialPropertyDescriptors.ACCESS_KEY, accessKeyId);
        runner.setProperty(credentialsService, CredentialPropertyDescriptors.SECRET_KEY, secretKey);

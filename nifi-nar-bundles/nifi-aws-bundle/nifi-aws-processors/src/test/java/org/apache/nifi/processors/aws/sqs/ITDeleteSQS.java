...
@Disabled("For local testing only - interacts with S3 so the credentials file must be configured and all necessary queues created")
public class ITDeleteSQS {
    ...
    public void testSimpleDelete() throws IOException {
        ...
        Assertions.assertEquals(200, sendMessageResult.getSdkHttpMetadata().getHttpStatusCode());
        ...
        Assertions.assertEquals(200, receiveMessageResult.getSdkHttpMetadata().getHttpStatusCode());

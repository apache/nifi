...
public class ITPutKinesis {
    ...
    public void testOneMessageWithMaxBufferSizeGreaterThan1MBOneSuccess() {
        ...
        runner.assertAllFlowFilesTransferred(PutKinesis.REL_SUCCESS, 1);
        List<MockFlowFile> flowFiles = runner.getFlowFilesForRelationship(PutKinesis.REL_SUCCESS);
    ...
    public void testTwoMessageBatch5WithMaxBufferSize1MBRunOnceTwoMessageSent() {
        ...
        for (MockFlowFile flowFile : flowFiles) {
            flowFile.assertAttributeExists(PutKinesis.AWS_KINESIS_SEQUENCE_NUMBER);
            flowFile.assertAttributeExists(PutKinesis.AWS_KINESIS_SHARD_ID);
        }
    }
    ...
    public void testThreeMessageWithBatch2MaxBufferSize1MBRunTwiceThreeMessageSent() {
        ...
        runner.assertAllFlowFilesTransferred(PutKinesis.REL_SUCCESS, 3);
        List<MockFlowFile> flowFiles = runner.getFlowFilesForRelationship(PutKinesis.REL_SUCCESS);
    ...
    public void testThreeMessageHello2MBThereWithBatch10MaxBufferSize1MBRunOnceTwoMessageSuccessOneFailed() {
        ...
        List<MockFlowFile> flowFilesFailed = runner.getFlowFilesForRelationship(PutKinesis.REL_FAILURE);
        assertEquals(1,flowFilesFailed.size());
        for (MockFlowFile flowFileFailed : flowFilesFailed) {
            assertNotNull(flowFileFailed.getAttribute(PutKinesis.AWS_KINESIS_ERROR_MESSAGE));
        }
    }
    ...
    public void test5MessageWithBatch10MaxBufferSize10MBRunOnce5MessageSent() {
        ...
        runner.assertAllFlowFilesTransferred(PutKinesis.REL_SUCCESS, 5);
        List<MockFlowFile> flowFiles = runner.getFlowFilesForRelationship(PutKinesis.REL_SUCCESS);

...
public class StandardS3ServerSideEncryptionService extends AbstractControllerService implements S3ServerSideEncryptionService {
    ...
    public String toString() {
        return "StandardS3ServerSideEncryptionService[id=" + getIdentifier() + "]";
    }
}
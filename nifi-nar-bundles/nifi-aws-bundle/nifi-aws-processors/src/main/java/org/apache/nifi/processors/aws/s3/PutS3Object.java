...
public class PutS3Object extends AbstractS3Processor {
    ...
    public static final PropertyDescriptor SERVER_SIDE_ENCRYPTION_SERVICE = new PropertyDescriptor.Builder()
            ...
            .description("Specifies an optional Server Side Encryption Service that, if provided, will be used to create connections")
            .required(false)
            .identifiesControllerService(S3ServerSideEncryptionService.class)
            .build();
    ...
    public static final List<PropertyDescriptor> properties = Collections.unmodifiableList(
        Arrays.asList(KEY, BUCKET, CONTENT_TYPE, ACCESS_KEY, SECRET_KEY, CREDENTIALS_FILE, AWS_CREDENTIALS_PROVIDER_SERVICE, STORAGE_CLASS, REGION, TIMEOUT, EXPIRATION_RULE_ID,
            FULL_CONTROL_USER_LIST, READ_USER_LIST, WRITE_USER_LIST, READ_ACL_LIST, WRITE_ACL_LIST, OWNER, CANNED_ACL, SSL_CONTEXT_SERVICE, CLIENT_SIDE_ENCRYPTION_SERVICE, SERVER_SIDE_ENCRYPTION_SERVICE,
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) {
        ...
        final S3ServerSideEncryptionService ssEncryptionService = context.getProperty(SERVER_SIDE_ENCRYPTION_SERVICE).asControllerService(S3ServerSideEncryptionService.class);
                ...
                public void process(final InputStream rawIn) throws IOException {
                    try (final InputStream in = new BufferedInputStream(rawIn)) {
                        ...
                        if (ff.getSize() <= multipartThreshold) {
                            ...
                            if (ssEncryptionService != null) {
                                ssEncryptionService.encrypt(request);
                            }
                            ...
                            if (currentState.getUploadId().isEmpty()) {
                                ...
                                if (ssEncryptionService != null) {
                                    ssEncryptionService.encrypt(initiateRequest);
                                }

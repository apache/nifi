...
public class PutLambda extends AbstractAWSLambdaProcessor {
    ...
    public static final List<PropertyDescriptor> properties = Collections.unmodifiableList(
            Arrays.asList(AWS_LAMBDA_FUNCTION_NAME, AWS_LAMBDA_FUNCTION_QUALIFIER, REGION, ACCESS_KEY, SECRET_KEY, CREDENTIALS_FILE, AWS_CREDENTIALS_PROVIDER_SERVICE,
                    ALLOW_ANONYMOUS_CREDENTIALS, TIMEOUT
            ));

 ...
 */
public abstract class AbstractKinesisStreamsProcessor extends AbstractAWSCredentialsProviderProcessor<AmazonKinesisClient> {

    public static final PropertyDescriptor KINESIS_STREAMS_DELIVERY_STREAM_NAME = new PropertyDescriptor.Builder()
            .name("Amazon Kinesis Streams Stream Name")
            .description("The name of kinesis Streams stream")
            .expressionLanguageSupported(false)
            .required(true)
            .addValidator(StandardValidators.NON_EMPTY_VALIDATOR)
            .build();

    public static final PropertyDescriptor NR_SHARDS = new PropertyDescriptor.Builder()
            .name("Number of Shards")
            .description("Number of shards configured on stream")
            .required(true)

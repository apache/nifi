...
/**
 * Abstract base class for ExecuteCypherQuery processors
 */
abstract class AbstractCypherExecutor extends AbstractProcessor {
    public static final PropertyDescriptor CLIENT_SERVICE = new PropertyDescriptor.Builder()
        .name("cypher-client-service")
        .displayName("Client Service")
        .description("The Cypher client service for connecting to the cypher-enabled database.")
        .required(true)
    ...
    public static final PropertyDescriptor QUERY = new PropertyDescriptor.Builder()
        ...
        .description("Specifies the Cypher Query.")
        .required(true)
    ...
    public static final String ERROR_MESSAGE = "cypher.error.message";

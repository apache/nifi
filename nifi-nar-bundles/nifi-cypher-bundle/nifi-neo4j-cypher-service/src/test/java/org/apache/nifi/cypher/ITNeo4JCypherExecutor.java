 ...
 *    <li>Change password to testing1234</li>
 * <code>CALL dbms.changePassword('testing1234')</code>
 *    <li> Restart neo4j</li>
 * <code>neo4j restart</code>
 *    <li>Log into cypher shell using new password (testing1234)</li>
 * <code>cypher-shell</code>
 * </ol>
 */
public class ITNeo4JCypherExecutor {
    ...
    private CypherClientService clientService;
    private CypherQueryResultCallback EMPTY_CALLBACK = (record, hasMore) -> {};
    ...
    public void testCreateNodeNoReturn() {
        ...
        assertEquals("1",attributes.get(CypherClientService.LABELS_ADDED));
        assertEquals("1",attributes.get(CypherClientService.NODES_CREATED));
        assertEquals("0",attributes.get(CypherClientService.NODES_DELETED));
        assertEquals("0",attributes.get(CypherClientService.RELATIONS_CREATED));
        assertEquals("0",attributes.get(CypherClientService.RELATIONS_DELETED));
        assertEquals("1",attributes.get(CypherClientService.PROPERTIES_SET));
        assertEquals("0",attributes.get(CypherClientService.ROWS_RETURNED));
    }
    ...
    public void testCreateNodeOnePropertyWithReturn() {
        ...
        assertEquals("0",attributes.get(CypherClientService.LABELS_ADDED));
        assertEquals("1",attributes.get(CypherClientService.NODES_CREATED));
        assertEquals("0",attributes.get(CypherClientService.NODES_DELETED));
        assertEquals("0",attributes.get(CypherClientService.RELATIONS_CREATED));
        assertEquals("0",attributes.get(CypherClientService.RELATIONS_DELETED));
        assertEquals("1",attributes.get(CypherClientService.PROPERTIES_SET));
        assertEquals("1",attributes.get(CypherClientService.ROWS_RETURNED));
    ...
    public void testCreateNodeTwoPropertyOneLabelWithReturn() {
        ...
        assertEquals("0",attributes.get(CypherClientService.RELATIONS_CREATED));
        assertEquals("0",attributes.get(CypherClientService.RELATIONS_DELETED));
        assertEquals("2",attributes.get(CypherClientService.PROPERTIES_SET));
        assertEquals("1",attributes.get(CypherClientService.ROWS_RETURNED));
        assertEquals(1, result.size());
        assertEquals("abc", result.get(0).get("n.name"));
    ...
    public void testCreateTwoNodeTwoPropertyOneRelationshipWithReturn() {
        ...
        assertEquals("2",attributes.get(CypherClientService.LABELS_ADDED));
        assertEquals("2",attributes.get(CypherClientService.NODES_CREATED));
        assertEquals("0",attributes.get(CypherClientService.NODES_DELETED));
        assertEquals("1",attributes.get(CypherClientService.RELATIONS_CREATED));
        assertEquals("0",attributes.get(CypherClientService.RELATIONS_DELETED));
        assertEquals("3",attributes.get(CypherClientService.PROPERTIES_SET));
        assertEquals("1",attributes.get(CypherClientService.ROWS_RETURNED));
        assertEquals(1, result.size());

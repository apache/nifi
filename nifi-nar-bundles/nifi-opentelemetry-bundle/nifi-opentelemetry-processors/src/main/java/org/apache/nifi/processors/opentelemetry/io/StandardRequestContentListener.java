...
public class StandardRequestContentListener implements RequestContentListener {
    ...
    private <T extends Message> List<Message> readMessages(
        ...
        if (parsed instanceof ExportLogsServiceRequest) {
            final ExportLogsServiceRequest request = (ExportLogsServiceRequest) parsed;
            ...
            final ExportMetricsServiceRequest request = (ExportMetricsServiceRequest) parsed;
            ...
            final ExportTraceServiceRequest request = (ExportTraceServiceRequest) parsed;
    ...
    private List<KeyValue> getClientSocketAttributes(final ServiceRequestDescription serviceRequestDescription) {
        ...
        return Arrays.asList(clientSocketAddress, clientSocketPort);
    }

    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        ugi.doAs((PrivilegedAction<Object>)() -> {
            ...
            try {
                ...
                getLogger().error("Failed to retrieve content from {} for {}", filenameValue, originalFlowFile, e);
                ...
                getLogger().error("Failed to retrieve content from {} for {}; routing to retry", filenameValue, originalFlowFile, e);
                session.transfer(session.penalize(originalFlowFile), REL_RETRY);
                context.yield();
            } catch (final Throwable t) {
                getLogger().error("Failed to retrieve content from {} for {}", filenameValue, originalFlowFile, t);

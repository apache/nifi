...
public class TableCapturePlan {
    ...
    public boolean getIncludePreupdateValues() {
        return includePreupdateValues;
    }
    ...
    private boolean includePreupdateValues;
    private Timestamp maxTime;

    private PlanTypes planType;

    public TableCapturePlan(MSSQLTableInfo table, int rowLimit, boolean captureBaseline, boolean includePreupdateValues, String sTime){
        this.table = table;

        this.rowLimit = rowLimit;
        this.captureBaseline = captureBaseline;
        this.includePreupdateValues = includePreupdateValues;
        ...
        if(getRowLimit() == 0){
           ...
           if(getMaxTime() == null) {
                ...
                if(getCaptureBaseline()){
                    ...
                    String sqlQuery = mssqlcdcUtils.getCDCRowCountStatement(getTable(), includePreupdateValues, null);
               ...
               //Assume CDC unless we have a reason to change it
                ...
                String sqlQuery = mssqlcdcUtils.getCDCRowCountStatement(getTable(), includePreupdateValues, getMaxTime());
                long rowCount = getRowCount(con, sqlQuery);

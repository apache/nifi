...
public class CaptureChangeMSSQLTest {
    ...
    public void testSelectGenerator(){
        ...
        String noMaxTime = mssqlcdcUtils.getCDCSelectStatement(ti, true, null);
        ...
        String withMaxTime = mssqlcdcUtils.getCDCSelectStatement(ti, true, new Timestamp(0));
        ...
        String noMaxTimeNoPreUpdateValues = mssqlcdcUtils.getCDCSelectStatement(ti, false, null);
        ...
        Assert.assertEquals("SELECT t.tran_begin_time\n" +
                ...
                "ORDER BY CAST(\"o\".\"__$start_lsn\" AS bigint), \"o\".\"__$seqval\", \"o\".\"__$operation\"", noMaxTimeNoPreUpdateValues);

        String withMaxTimeNoPreUpdateValues = mssqlcdcUtils.getCDCSelectStatement(ti, false, new Timestamp(0));

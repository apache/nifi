...
import static org.apache.nifi.processors.smb.NiFiSmbClient.unifyDirectorySeparators;
...
class NiFiSmbClientTest {

    @Mock
    DiskShare share;

    @InjectMocks
    NiFiSmbClient underTest;
    ...
    @Test
    public void shouldUnifyDirectoryProperty() {
        final String directoryProperty = "path\\with/mixed\\directory/separators";
        assertEquals("path\\with\\mixed\\directory\\separators", unifyDirectorySeparators(directoryProperty));
    }

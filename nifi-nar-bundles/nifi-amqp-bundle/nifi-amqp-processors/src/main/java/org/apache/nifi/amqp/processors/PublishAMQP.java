...
public class PublishAMQP extends AbstractAMQPProcessor<AMQPPublisher> {
    ...
    public void onScheduled(ProcessContext context) {
        ...
        selectedHeaderSource = context.getProperty(HEADERS_SOURCE).getValue();
    ...
    /**
     * Extract AMQP headers from incoming {@link FlowFile} based on selected headers source {@link PublishAMQP#selectedHeaderSource} value.
     *
    ...
    /**
     * Matches the {@link PublishAMQP#pattern} to keys of input attributes and output the amqp headers map
     * @param attributes flowFile attributes to scan for match
     * @return Map with entries matching the pattern
     */
    private Map<String, String> attributesToHeaders(Map<String, String> attributes) {

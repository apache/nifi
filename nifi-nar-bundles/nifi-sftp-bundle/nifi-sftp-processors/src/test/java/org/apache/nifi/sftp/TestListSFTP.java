...
public class TestListSFTP {
    ...
    public void startServer() throws Exception {
        ...
        runner.setProperty(AbstractListProcessor.TARGET_SYSTEM_TIMESTAMP_PRECISION, AbstractListProcessor.PRECISION_MILLIS);
        runner.assertValid();
    }
    ...
    public void testRunFileFound() {
        ...
        runner.assertAllFlowFilesContainAttribute(GetFileTransfer.FILE_OWNER_ATTRIBUTE);
        runner.assertAllFlowFilesContainAttribute(GetFileTransfer.FILE_GROUP_ATTRIBUTE);
        runner.assertAllFlowFilesContainAttribute(GetFileTransfer.FILE_PERMISSIONS_ATTRIBUTE);
        runner.assertAllFlowFilesContainAttribute(GetFileTransfer.FILE_SIZE_ATTRIBUTE);
        runner.assertAllFlowFilesContainAttribute(GetFileTransfer.FILE_LAST_MODIFY_TIME_ATTRIBUTE);
    ...
    public void testRunFileNotFoundMinSizeFiltered() {
        runner.setProperty(ListSFTP.MIN_SIZE, "1KB");

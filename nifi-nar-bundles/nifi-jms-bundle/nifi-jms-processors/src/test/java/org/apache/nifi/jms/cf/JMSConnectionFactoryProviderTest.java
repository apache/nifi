...
public class JMSConnectionFactoryProviderTest {
    ...
    public void validateELExpression() throws InitializationException {
        ...
        runner.setEnvironmentSystemVariableValue("broker.uri", SINGLE_TEST_BROKER_WITH_SCHEME_AND_IP);
        runner.setEnvironmentSystemVariableValue("client.lib", dummyResource);
    ...
    public void testClientLibResourcesLoaded() throws InitializationException {
        ...
        runner.setEnvironmentSystemVariableValue("broker.uri", SINGLE_TEST_BROKER_WITH_SCHEME_AND_IP);
        runner.setEnvironmentSystemVariableValue("client.lib", allDummyResources);
    ...
    public void dynamicPropertiesSetOnSingleTestBrokerConnectionFactory() throws InitializationException {
        ...
        runner.setEnvironmentSystemVariableValue("test", "dynamicValue");

...
public class PublishJMSIT {
    ...
    public void validateNIFI7563() throws Exception {
        ...
        try {
            ...
            runner.run(2);
            assertEquals("It is expected only one Connection to be opened.", 1, connectionFactoryProxy.openedConnections());
            assertEquals("It is expected only one Session to be opened.", 1, connectionFactoryProxy.openedSessions());
            assertEquals("It is expected only one MessageProducer to be opened.", 1, connectionFactoryProxy.openedProducers());

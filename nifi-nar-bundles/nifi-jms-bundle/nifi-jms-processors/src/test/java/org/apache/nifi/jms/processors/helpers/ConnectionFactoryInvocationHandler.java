...
/**
 * {@link ConnectionFactory}'s invocation handler to be used to create {@link Proxy} instances. This handler stores useful information to validate the proper resources handling of underlying
 * connection factory.
 */
@ThreadSafe

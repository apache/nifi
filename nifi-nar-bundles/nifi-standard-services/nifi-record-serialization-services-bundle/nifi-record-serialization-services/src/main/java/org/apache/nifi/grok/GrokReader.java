...
public class GrokReader extends SchemaRegistryService implements RecordReaderFactory {
    ...
    private volatile String unmatchBehavior;
    ...
    static final AllowableValue THROW_ERROR = new AllowableValue("throw-error", "Error",
            "The processing of the flow file containing the line of text will issue an error and will be routed to the appropriate relationship.");
    ...
    static final PropertyDescriptor NO_MATCH_BEHAVIOR = new PropertyDescriptor.Builder()
        ...
        .allowableValues(APPEND_TO_PREVIOUS_MESSAGE, SKIP_LINE, THROW_ERROR)
    ...
    public void preCompile(final ConfigurationContext context) throws GrokException, IOException {
        ...
        unmatchBehavior = context.getProperty(NO_MATCH_BEHAVIOR).getValue();
    ...
    public RecordReader createRecordReader(final Map<String, String> variables, final InputStream in, final ComponentLog logger) throws IOException, SchemaNotFoundException {
        ...
        return new GrokRecordReader(in, grok, schema, recordSchemaFromGrok, unmatchBehavior);
    }
}
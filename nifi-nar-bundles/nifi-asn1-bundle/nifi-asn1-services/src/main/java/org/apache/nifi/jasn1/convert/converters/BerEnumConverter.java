...
public class BerEnumConverter implements JASN1TypeAndValueConverter {
    @Override
    public boolean supportsType(Class<?> berType) {
        return BerEnum.class.isAssignableFrom(berType);
    }

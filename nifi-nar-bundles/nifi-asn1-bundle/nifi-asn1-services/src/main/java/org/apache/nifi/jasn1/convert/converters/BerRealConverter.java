...
public class BerRealConverter implements JASN1TypeAndValueConverter {
    @Override
    public boolean supportsType(Class<?> berType) {
        return BerReal.class.isAssignableFrom(berType);
    }

...
public class BerOctetStringConverter implements JASN1TypeAndValueConverter {
    @Override
    public boolean supportsType(Class<?> berType) {
        return BerOctetString.class.isAssignableFrom(berType);
    }
    ...
    public boolean supportsValue(BerType value, DataType dataType) {
        return value instanceof BerOctetString;
    }

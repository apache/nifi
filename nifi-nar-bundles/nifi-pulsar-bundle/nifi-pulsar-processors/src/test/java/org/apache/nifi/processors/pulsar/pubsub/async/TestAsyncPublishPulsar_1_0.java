...
public class TestAsyncPublishPulsar_1_0 extends TestPublishPulsar_1_0 {
    ...
    public void singleFlowFileTest() throws UnsupportedEncodingException, PulsarClientException, InterruptedException {
        ...
        outFile.assertAttributeEquals(PublishPulsarRecord_1_0.MSG_COUNT, "1");
        outFile.assertAttributeEquals(PublishPulsarRecord_1_0.TOPIC_NAME, "my-topic");
    ...
    public void multipleFlowFilesTest() throws UnsupportedEncodingException, PulsarClientException {
        ...
        outFile.assertContentEquals(content);
        outFile.assertAttributeEquals(PublishPulsarRecord_1_0.MSG_COUNT, "1");
        outFile.assertAttributeEquals(PublishPulsarRecord_1_0.TOPIC_NAME, "my-async-topic");

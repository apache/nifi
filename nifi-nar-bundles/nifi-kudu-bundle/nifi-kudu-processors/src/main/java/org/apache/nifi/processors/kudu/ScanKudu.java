...
@CapabilityDescription("Scans and fetches rows from an Kudu table. This processor may be used to fetch rows from Kudu table by specifying list of predicates")
@WritesAttributes({
...
public class ScanKudu extends AbstractKuduProcessor {
    ...
    static final PropertyDescriptor PREDICATES = new PropertyDescriptor.Builder()
            .name("Predicates")
            .description("A comma-separated list of \"<colName>:<value>\" pairs to return when scanning.")
            .required(true)
            .expressionLanguageSupported(ExpressionLanguageScope.FLOWFILE_ATTRIBUTES)
    ...
    protected List<PropertyDescriptor> getSupportedPropertyDescriptors() {
        ...
        properties.add(KUDU_SOCKET_OPERATION_TIMEOUT_MS);

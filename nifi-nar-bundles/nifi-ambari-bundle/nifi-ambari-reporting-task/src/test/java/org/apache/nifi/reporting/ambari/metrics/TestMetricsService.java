...
public class TestMetricsService {
    ...
    public void testGetProcessGroupStatusMetrics() {
        ...
        Assertions.assertTrue(metrics.containsKey(MetricNames.TOTAL_TASK_DURATION_SECONDS));
        Assertions.assertTrue(metrics.containsKey(MetricNames.TOTAL_TASK_DURATION_NANOS));
    }
    ...
    public void testGetProcessGroupStatusMetricsWithID() {
        ...
        Assertions.assertTrue(metrics.containsKey(MetricNames.FLOW_FILES_RECEIVED + MetricNames.METRIC_NAME_SEPARATOR + id));
    }

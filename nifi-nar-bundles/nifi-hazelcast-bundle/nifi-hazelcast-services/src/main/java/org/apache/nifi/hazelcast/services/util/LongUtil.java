...
public final class LongUtil {
     ...
     */
    public static byte[] toBytesWithPadding(long input) {
     ...
     *
     * Note: <code>new BigInteger(bytes).longValue()</code> behaves similar.
     *
     ...
     */
    public static long fromPaddedBytes(final byte[] bytes) {
        long result = 0;

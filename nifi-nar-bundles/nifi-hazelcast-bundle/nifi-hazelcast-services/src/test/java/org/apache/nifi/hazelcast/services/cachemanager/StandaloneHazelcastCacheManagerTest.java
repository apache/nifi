...
public class StandaloneHazelcastCacheManagerTest extends AbstractHazelcastCacheManagerTest {
    ...
    public void testExecution() throws Exception {
        ...
        testRunner.setProperty(testSubject, IMapBasedHazelcastCacheManager.HAZELCAST_INSTANCE_NAME, "test");
        testRunner.setProperty(testSubject, StandaloneHazelcastCacheManager.HAZELCAST_SERVER_ADDRESS, "localhost:5701");

...
public class TestPublishKafka_2_0 {
    ...
    public void testTimestampSingleFailure() throws IOException {
        ...
        final List<MockFlowFile> failedFiles = runner.getFlowFilesForRelationship(PublishKafka_2_0.REL_FAILURE);
    ...
    public void testTimestampPartialFailure() throws IOException {
        ...
        runner.run();
        runner.assertTransferCount(PublishKafka_2_0.REL_SUCCESS, 2);
        runner.assertTransferCount(PublishKafka_2_0.REL_FAILURE, 1);

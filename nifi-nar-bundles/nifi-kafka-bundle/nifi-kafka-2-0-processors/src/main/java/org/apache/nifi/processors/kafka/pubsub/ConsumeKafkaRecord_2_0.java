...
public class ConsumeKafkaRecord_2_0 extends AbstractProcessor {
    ...
    protected ConsumerPool createConsumerPool(final ProcessContext context, final ComponentLog log) {
        ...
        if (topicType.equals(TOPIC_NAME.getValue())) {
            ...
            return new ConsumerPool(maxLeases, readerFactory, writerFactory, props, topics, maxUncommittedTime, maxPollRecords, securityProtocol,
            ...
            return new ConsumerPool(maxLeases, readerFactory, writerFactory, props, topicPattern, maxUncommittedTime, maxPollRecords, securityProtocol,
                bootstrapServers, log, honorTransactions, charset, headerNamePattern);
        } else {

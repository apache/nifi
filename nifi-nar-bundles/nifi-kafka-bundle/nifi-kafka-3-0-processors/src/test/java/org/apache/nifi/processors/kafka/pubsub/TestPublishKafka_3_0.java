...
public class TestPublishKafka_3_0 {
    ...
    public void setup() {
        ...
        runner = TestRunners.newTestRunner(new PublishKafka_3_0() {
            @Override
        ...
        runner.setProperty(PublishKafka_3_0.TOPIC, TOPIC_NAME);
    ...
    public void testSingleSuccess() throws IOException {
        ...
        runner.run();
        runner.assertAllFlowFilesTransferred(PublishKafka_3_0.REL_SUCCESS, 1);
    ...
    public void testMultipleSuccess() throws IOException {
        ...
        runner.run();
        runner.assertAllFlowFilesTransferred(PublishKafka_3_0.REL_SUCCESS, 3);
    ...
    public void testPublisherPoisonedIfFencedDuringTransactionCreation() {
        ...
        runner.run();
        runner.assertAllFlowFilesTransferred(PublishKafka_3_0.REL_FAILURE, 2);
    ...
    public void testSingleFailure() throws IOException {
        ...
        runner.run();
        runner.assertAllFlowFilesTransferred(PublishKafka_3_0.REL_FAILURE, 1);
    ...
    public void testSingleFailureWithRollback() throws IOException {
        ...
        runner.run();
        runner.assertAllFlowFilesTransferred(PublishKafka_3_0.REL_FAILURE, 0);
    ...
    public void testMultipleFailures() throws IOException {
        ...
        runner.run();
        runner.assertAllFlowFilesTransferred(PublishKafka_3_0.REL_FAILURE, 3);
    ...
    public void testMultipleMessagesPerFlowFile() throws IOException {
        ...
        runner.run();
        runner.assertAllFlowFilesTransferred(PublishKafka_3_0.REL_SUCCESS, 2);
        ...
        assertEquals(1, runner.getFlowFilesForRelationship(PublishKafka_3_0.REL_SUCCESS).stream()
    ...
    public void testSomeSuccessSomeFailure() throws IOException {
        ...
        runner.run();
        runner.assertTransferCount(PublishKafka_3_0.REL_SUCCESS, 0);
        runner.assertTransferCount(PublishKafka_3_0.REL_FAILURE, 4);
        ...
        assertTrue(runner.getFlowFilesForRelationship(PublishKafka_3_0.REL_FAILURE).stream()

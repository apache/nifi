...
public class TestConsumeKafkaRecord_3_0 {
    ...
    public void setup() throws InitializationException {
        ...
        ConsumeKafkaRecord_3_0 proc = new ConsumeKafkaRecord_3_0() {
            @Override
        ...
        runner.setProperty(ConsumeKafkaRecord_3_0.RECORD_READER, readerId);
        runner.setProperty(ConsumeKafkaRecord_3_0.RECORD_WRITER, writerId);
    }

    @Test
    public void validateCustomValidatorSettings() throws Exception {
        runner.setProperty(ConsumeKafkaRecord_3_0.TOPICS, "foo");
        runner.setProperty(ConsumeKafkaRecord_3_0.GROUP_ID, "foo");
        runner.setProperty(ConsumeKafkaRecord_3_0.AUTO_OFFSET_RESET, ConsumeKafkaRecord_3_0.OFFSET_EARLIEST);
    ...
    public void validatePropertiesValidation() throws Exception {
        ...
        runner.removeProperty(ConsumeKafkaRecord_3_0.GROUP_ID);
        try {
            runner.assertValid();
            fail();
        ...
        runner.setProperty(ConsumeKafkaRecord_3_0.GROUP_ID, "");
        try {
            runner.assertValid();
            fail();
        } catch (AssertionError e) {
    ...
    public void validateGetAllMessages() throws Exception {
        ...
        runner.setProperty(ConsumeKafkaRecord_3_0.TOPICS, "foo,bar");
        runner.setProperty(ConsumeKafkaRecord_3_0.GROUP_ID, groupName);
        runner.setProperty(ConsumeKafkaRecord_3_0.AUTO_OFFSET_RESET, ConsumeKafkaRecord_3_0.OFFSET_EARLIEST);
        runner.run(1, false);
    ...
    public void validateGetAllMessagesPattern() throws Exception {
        ...
        runner.setProperty(ConsumeKafkaRecord_3_0.TOPICS, "(fo.*)|(ba)");
        runner.setProperty(ConsumeKafkaRecord_3_0.TOPIC_TYPE, "pattern");
        runner.setProperty(ConsumeKafkaRecord_3_0.GROUP_ID, groupName);
        runner.setProperty(ConsumeKafkaRecord_3_0.AUTO_OFFSET_RESET, ConsumeKafkaRecord_3_0.OFFSET_EARLIEST);
        runner.run(1, false);

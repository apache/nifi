...
public class TestPublishKafkaRecord_3_0 {
    ...
    public void setup() throws InitializationException, IOException {
        ...
        runner = TestRunners.newTestRunner(new PublishKafkaRecord_3_0() {
            @Override
        ...
        runner.setProperty(PublishKafkaRecord_3_0.TOPIC, TOPIC_NAME);
        ...
        runner.setProperty(PublishKafkaRecord_3_0.RECORD_READER, readerId);
        runner.setProperty(PublishKafkaRecord_3_0.RECORD_WRITER, writerId);
        runner.setProperty(PublishKafka_3_0.DELIVERY_GUARANTEE, PublishKafka_3_0.DELIVERY_REPLICATED);
    }
    ...
    public void testSingleSuccess() throws IOException {
        ...
        runner.run();
        runner.assertAllFlowFilesTransferred(PublishKafkaRecord_3_0.REL_SUCCESS, 1);
    ...
    public void testMultipleSuccess() throws IOException {
        ...
        runner.run();
        runner.assertAllFlowFilesTransferred(PublishKafkaRecord_3_0.REL_SUCCESS, 3);
    ...
    public void testSingleFailure() throws IOException {
        ...
        runner.run();
        runner.assertAllFlowFilesTransferred(PublishKafkaRecord_3_0.REL_FAILURE, 1);
    ...
    public void testSingleFailureWithRollback() throws IOException {
        ...
        runner.run();
        runner.assertAllFlowFilesTransferred(PublishKafkaRecord_3_0.REL_FAILURE, 0);
    ...
    public void testMultipleFailures() throws IOException {
        ...
        runner.run();
        runner.assertAllFlowFilesTransferred(PublishKafkaRecord_3_0.REL_FAILURE, 3);
    ...
    public void testMultipleMessagesPerFlowFile() throws IOException {
        ...
        runner.run();
        runner.assertAllFlowFilesTransferred(PublishKafkaRecord_3_0.REL_SUCCESS, 2);
        ...
        assertEquals(1, runner.getFlowFilesForRelationship(PublishKafkaRecord_3_0.REL_SUCCESS).stream()
    ...
    public void testNoRecordsInFlowFile() throws IOException {
        ...
        final MockFlowFile mff = runner.getFlowFilesForRelationship(PublishKafkaRecord_3_0.REL_SUCCESS).get(0);
        mff.assertAttributeEquals("msg.count", "0");
    }

    @Test
    public void testRecordPathPartition() throws IOException {
        runner.setProperty(PublishKafkaRecord_3_0.PARTITION_CLASS, PublishKafkaRecord_3_0.RECORD_PATH_PARTITIONING);
        runner.setProperty(PublishKafkaRecord_3_0.PARTITION, "/age");
    ...
    public void testSomeSuccessSomeFailure() throws IOException {
        ...
        runner.run();
        runner.assertTransferCount(PublishKafkaRecord_3_0.REL_SUCCESS, 0);
        runner.assertTransferCount(PublishKafkaRecord_3_0.REL_FAILURE, 4);
        ...
        assertTrue(runner.getFlowFilesForRelationship(PublishKafkaRecord_3_0.REL_FAILURE).stream()

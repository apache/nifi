...
public class TestConsumeKafka_3_0 {
    ...
    public void validateCustomValidatorSettings() throws Exception {
        ConsumeKafka_3_0 consumeKafka = new ConsumeKafka_3_0();
        TestRunner runner = TestRunners.newTestRunner(consumeKafka);
        runner.setProperty(KafkaProcessorUtils.BOOTSTRAP_SERVERS, "okeydokey:1234");
        runner.setProperty(ConsumeKafka_3_0.TOPICS, "foo");
        runner.setProperty(ConsumeKafka_3_0.GROUP_ID, "foo");
        runner.setProperty(ConsumeKafka_3_0.AUTO_OFFSET_RESET, ConsumeKafka_3_0.OFFSET_EARLIEST);
    ...
    public void validatePropertiesValidation() throws Exception {
        ...
        runner.removeProperty(ConsumeKafka_3_0.GROUP_ID);
        try {
            runner.assertValid();
            fail();
        ...
        runner.setProperty(ConsumeKafka_3_0.GROUP_ID, "");
        try {
            runner.assertValid();
            fail();
        } catch (AssertionError e) {

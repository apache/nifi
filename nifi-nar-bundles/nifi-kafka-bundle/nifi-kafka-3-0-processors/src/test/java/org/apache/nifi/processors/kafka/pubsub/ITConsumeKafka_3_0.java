...
public class ITConsumeKafka_3_0 {
    ...
    public void validateGetAllMessages() throws Exception {
        ...
        ConsumeKafka_3_0 proc = new ConsumeKafka_3_0() {
            @Override
        ...
        runner.setProperty(ConsumeKafka_3_0.TOPICS, "foo,bar");
        runner.setProperty(ConsumeKafka_3_0.GROUP_ID, groupName);
    ...
    public void validateGetAllMessagesPattern() throws Exception {
        ...
        final TestRunner runner = TestRunners.newTestRunner(proc);
        runner.setProperty(KafkaProcessorUtils.BOOTSTRAP_SERVERS, "0.0.0.0:1234");
        runner.setProperty(ConsumeKafka_3_0.TOPICS, "(fo.*)|(ba)");
        runner.setProperty(ConsumeKafka_3_0.TOPIC_TYPE, "pattern");
        runner.setProperty(ConsumeKafka_3_0.GROUP_ID, groupName);
        runner.setProperty(ConsumeKafka_3_0.AUTO_OFFSET_RESET, ConsumeKafka_3_0.OFFSET_EARLIEST);
        runner.run(1, false);

...
public class TestPublisherPool {
    ...
    public void testLeaseCloseReturnsToPool() {
        ...
        final PublisherPool pool = new PublisherPool(kafkaProperties, Mockito.mock(ComponentLog.class), 1024 * 1024, 1000L, false, null, null, StandardCharsets.UTF_8, null);

...
import static org.apache.nifi.processors.kafka.pubsub.PublishKafkaRecord_0_11.DELIVERY_REPLICATED;
...
public class TestPublishKafka {
    ...
    public void validateKafkaTopicName() throws Exception {
        ...
        runner.setProperty(PublishKafka_0_11.DELIVERY_GUARANTEE, DELIVERY_REPLICATED);

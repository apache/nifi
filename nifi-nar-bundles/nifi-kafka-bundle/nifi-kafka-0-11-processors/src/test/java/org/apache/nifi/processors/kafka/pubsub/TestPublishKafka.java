...
public class TestPublishKafka {
    ...
    public void setup() {
        ...
        runner = TestRunners.newTestRunner(new PublishKafka_0_11() {
            @Override
        ...
        ProcessSessionFactory sessionFactory = runner.getProcessSessionFactory();



        runner.setProperty(PublishKafka_0_11.TOPIC, TOPIC_NAME);
    ...
    public void testSingleSuccess() throws IOException {
        ...
        runner.run();
        runner.assertAllFlowFilesTransferred(PublishKafka_0_11.REL_SUCCESS, 1);
    ...
    public void testSingleFailure() throws IOException {
        ...
        runner.run();
        runner.assertAllFlowFilesTransferred(PublishKafka_0_11.REL_FAILURE, 1);
    ...
    public void testMultipleMessagesPerFlowFile() throws IOException {
        ...
        runner.run();
        runner.assertAllFlowFilesTransferred(PublishKafka_0_11.REL_SUCCESS, 2);
        ...
        assertEquals(1, runner.getFlowFilesForRelationship(PublishKafka_0_11.REL_SUCCESS).stream()
    ...
    public void testSomeSuccessSomeFailure() throws IOException {
        ...
        runner.run();
        runner.assertTransferCount(PublishKafka_0_11.REL_SUCCESS, 0);
        runner.assertTransferCount(PublishKafka_0_11.REL_FAILURE, 4);

        verify(mockLease, times(4)).publish(any(FlowFile.class), any(InputStream.class), eq(null), eq(null), eq(TOPIC_NAME));
        verify(mockLease, times(1)).complete();
        verify(mockLease, times(1)).close();

        assertTrue(runner.getFlowFilesForRelationship(PublishKafka_0_11.REL_FAILURE).stream()
    ...
    public void testTimestampSingleFailure() throws IOException {
        ...
        final List<MockFlowFile> failedFiles = runner.getFlowFilesForRelationship(PublishKafka_0_11.REL_FAILURE);
    ...
    public void testTimestampPartialFailure() throws IOException {
        ...
        runner.run();
        runner.assertTransferCount(PublishKafka_0_11.REL_SUCCESS, 2);
        runner.assertTransferCount(PublishKafka_0_11.REL_FAILURE, 1);

...
@CapabilityDescription("Consumes messages from Apache Kafka specifically built against the Kafka 2.1 Consumer API. "
    + "The complementary NiFi processor for sending messages is PublishKafkaRecord_2_1. Please note that, at this time, the Processor assumes that "
...
@SeeAlso({ConsumeKafka_2_1.class, PublishKafka_2_1.class, PublishKafkaRecord_2_1.class})
public class ConsumeKafkaRecord_2_1 extends AbstractProcessor {
    ...
    protected ConsumerPool createConsumerPool(final ProcessContext context, final ComponentLog log) {
        ...
        final String topicListing = context.getProperty(ConsumeKafkaRecord_2_1.TOPICS).evaluateAttributeExpressions().getValue();
        final String topicType = context.getProperty(ConsumeKafkaRecord_2_1.TOPIC_TYPE).evaluateAttributeExpressions().getValue();

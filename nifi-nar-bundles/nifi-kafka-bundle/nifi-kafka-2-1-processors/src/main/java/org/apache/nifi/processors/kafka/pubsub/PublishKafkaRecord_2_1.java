...
@Tags({"Apache", "Kafka", "Record", "csv", "json", "avro", "logs", "Put", "Send", "Message", "PubSub", "2.1"})
@CapabilityDescription("Sends the contents of a FlowFile as individual records to Apache Kafka using the Kafka 2.1 Producer API. "
    + "The contents of the FlowFile are expected to be record-oriented data that can be read by the configured Record Reader. "
    + "The complementary NiFi processor for fetching messages is ConsumeKafkaRecord_2_1.")
...
@SeeAlso({PublishKafka_2_1.class, ConsumeKafka_2_1.class, ConsumeKafkaRecord_2_1.class})
public class PublishKafkaRecord_2_1 extends AbstractProcessor {

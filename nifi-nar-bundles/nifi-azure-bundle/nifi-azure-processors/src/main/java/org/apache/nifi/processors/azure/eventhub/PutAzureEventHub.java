...
@CapabilityDescription("Sends the contents of a FlowFile to Azure Event Hubs. Note: the content of the FlowFile will be buffered into memory before being sent, "

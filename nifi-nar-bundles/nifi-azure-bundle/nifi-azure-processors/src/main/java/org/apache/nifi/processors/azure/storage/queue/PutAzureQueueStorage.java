...
public class PutAzureQueueStorage extends AbstractAzureQueueStorage {
    ...
    private static final List<PropertyDescriptor> properties =  Collections.unmodifiableList(Arrays.asList(
            AzureStorageUtils.STORAGE_CREDENTIALS_SERVICE, AzureStorageUtils.ACCOUNT_NAME, AzureStorageUtils.ACCOUNT_KEY, AzureStorageUtils.ENDPOINT_SUFFIX, AzureStorageUtils.PROP_SAS_TOKEN,

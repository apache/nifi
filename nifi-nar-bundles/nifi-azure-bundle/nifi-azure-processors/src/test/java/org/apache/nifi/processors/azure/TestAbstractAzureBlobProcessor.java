...
public class TestAbstractAzureBlobProcessor {
    @Test
    public void testGetBlobName() {
        final AbstractAzureBlobProcessor processor = new AbstractAzureBlobProcessor() {
            @Override
        ...
        context.setProperty(AbstractAzureBlobProcessor.BLOB, "${path}/${filename}");

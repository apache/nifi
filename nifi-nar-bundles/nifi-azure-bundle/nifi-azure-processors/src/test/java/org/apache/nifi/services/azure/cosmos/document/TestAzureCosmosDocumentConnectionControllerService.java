...
public class TestAzureCosmosDocumentConnectionControllerService {

    private static final String MOCK_URI = "https://mockURI:443/";
    private static final String DB_ACCESS_KEY = "mockDB_ACCESS_KEY";

    private TestRunner runner;
    private AzureCosmosDocumentConnectionControllerService service;

    @Before
    public void setUp() throws InitializationException {
        runner = TestRunners.newTestRunner(NoOpProcessor.class);
        service = new AzureCosmosDocumentConnectionControllerService();
    ...
    private void configureURI() {
        runner.setProperty(service, AzureCosmosDocumentConnectionControllerService.URI, MOCK_URI);
    }

    private void configureDBAccessKey() {
        runner.setProperty(service, AzureCosmosDocumentConnectionControllerService.DB_ACCESS_KEY, DB_ACCESS_KEY);
    }

...
public class ITPutAzureCosmosDBDocument extends ITAbstractAzureCosmosDBDocument {
    static Logger logger = Logger.getLogger(ITPutAzureCosmosDBDocument.class.getName());

    @Override
    protected Class<? extends Processor> getProcessorClass() {
        return PutAzureCosmosDBDocument.class;
    }
    ...
    public void testOnTriggerWithoutDocumentId() {
        ...
        runner.run();
        runner.assertAllFlowFilesTransferred(PutAzureCosmosDBDocument.REL_SUCCESS, 1);
    }
    ...
    public void testOnTriggerWithMalformattedDocument() {
        ...
        runner.enqueue(document.getBytes());
        runner.run();
        runner.assertTransferCount(PutAzureCosmosDBDocument.REL_FAILURE, 1);
        runner.assertTransferCount(PutAzureCosmosDBDocument.REL_SUCCESS, 0);

    }

    @Test
    public void testOnTriggerWithNoPartitionKeyValue() {
        // PutAzureCosmosDBDocument will reject the data without partition key value

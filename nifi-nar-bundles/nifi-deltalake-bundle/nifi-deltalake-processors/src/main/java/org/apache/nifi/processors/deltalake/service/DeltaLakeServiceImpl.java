...
import static org.apache.nifi.processors.deltalake.UpdateDeltaLakeTable.PARQUET_SCHEMA_INPUT_TEXT;
import static org.apache.nifi.processors.deltalake.UpdateDeltaLakeTable.PARQUET_SCHEMA_SELECTOR;
import static org.apache.nifi.processors.deltalake.UpdateDeltaLakeTable.PARTITION_COLUMNS;
import static org.apache.nifi.processors.deltalake.UpdateDeltaLakeTable.SCHEMA_FILE_JSON;
import static org.apache.nifi.processors.deltalake.UpdateDeltaLakeTable.SCHEMA_TEXT_JSON;

public class DeltaLakeServiceImpl implements DeltaLakeService{

    private StorageService storageService;
    private DeltaTableService deltaTableService;

    public DeltaLakeServiceImpl(ProcessContext processorContext) {
    ...
    private StructType getParquetSchema(ProcessContext processorContext) {
        ...
        if (parquetSchemaType.equals(PARQUET_SCHEMA_INPUT_TEXT.getValue())) {
            ...
            try {
                ...
                throw new RuntimeException("Error reading the parquet schema", e);
            }
        }

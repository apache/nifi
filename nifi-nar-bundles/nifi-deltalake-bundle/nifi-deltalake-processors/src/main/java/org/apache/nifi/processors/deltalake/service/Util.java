...
public abstract class Util {
    ...
    public static String getFileNameWithPartitionColumns(String fileName, List<String> partitionColumns) {
        String separator = FileSystems.getDefault().getSeparator();
        List<String> pathElements = Arrays.stream(fileName.split(separator)).collect(Collectors.toList());

 ...
 * </p>
 */
public class ConnectionStatusTableScan extends TableScan implements EnumerableRel {
    final ConnectionStatusTable connectionStatusTable;
    final int[] fields;

    protected ConnectionStatusTableScan(final RelOptCluster cluster, final RelOptTable table, final ConnectionStatusTable connectionStatusTable, final int[] fields) {
        super(cluster, cluster.traitSetOf(EnumerableConvention.INSTANCE), table);

        this.connectionStatusTable = connectionStatusTable;
        this.fields = fields;
    }

    @Override
    public RelNode copy(final RelTraitSet traitSet, final List<RelNode> inputs) {
        return new ConnectionStatusTableScan(getCluster(), table, connectionStatusTable, fields);
    }

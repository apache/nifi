 ...
 * </p>
 */
public class ProcessGroupStatusTableScan extends TableScan implements EnumerableRel {
    final ProcessGroupStatusTable processGroupStatusTable;
    final int[] fields;

    protected ProcessGroupStatusTableScan(final RelOptCluster cluster, final RelOptTable table, final ProcessGroupStatusTable processGroupStatusTable, final int[] fields) {
        super(cluster, cluster.traitSetOf(EnumerableConvention.INSTANCE), table);

        this.processGroupStatusTable = processGroupStatusTable;
        this.fields = fields;
    }

    @Override
    public RelNode copy(final RelTraitSet traitSet, final List<RelNode> inputs) {
        return new ProcessGroupStatusTableScan(getCluster(), table, processGroupStatusTable, fields);
    }

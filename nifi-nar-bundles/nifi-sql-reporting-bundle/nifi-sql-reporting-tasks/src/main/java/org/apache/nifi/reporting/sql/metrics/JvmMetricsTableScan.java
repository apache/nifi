 ...
 * </p>
 */
public class JvmMetricsTableScan extends TableScan implements EnumerableRel {
    final JvmMetricsTable jvmMetricsTable;
    final int[] fields;

    protected JvmMetricsTableScan(final RelOptCluster cluster, final RelOptTable table, final JvmMetricsTable jvmMetricsTable, final int[] fields) {
        super(cluster, cluster.traitSetOf(EnumerableConvention.INSTANCE), table);

        this.jvmMetricsTable = jvmMetricsTable;
        this.fields = fields;
    }

    @Override
    public RelNode copy(final RelTraitSet traitSet, final List<RelNode> inputs) {
        return new JvmMetricsTableScan(getCluster(), table, jvmMetricsTable, fields);
    }

...
/**
 * Planner rule that projects from a {@link ConnectionStatusTableScan} scan just the columns
...
public class ConnectionStatusProjectTableScanRule extends RelOptRule {
    ...
    public void onMatch(RelOptRuleCall call) {
        ...
        final ConnectionStatusTableScan scan = call.rel(1);
        ...
        call.transformTo(
            new ConnectionStatusTableScan(
                scan.getCluster(),
                scan.getTable(),
                scan.connectionStatusTable,
                fields));
    }

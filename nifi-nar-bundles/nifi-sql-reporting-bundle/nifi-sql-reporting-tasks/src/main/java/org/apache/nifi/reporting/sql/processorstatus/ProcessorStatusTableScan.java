 ...
 * </p>
 */
public class ProcessorStatusTableScan extends TableScan implements EnumerableRel {
    final ProcessorStatusTable processorStatusTable;
    final int[] fields;

    protected ProcessorStatusTableScan(final RelOptCluster cluster, final RelOptTable table, final ProcessorStatusTable processorStatusTable, final int[] fields) {
        super(cluster, cluster.traitSetOf(EnumerableConvention.INSTANCE), table);

        this.processorStatusTable = processorStatusTable;
        this.fields = fields;
    }

    @Override
    public RelNode copy(final RelTraitSet traitSet, final List<RelNode> inputs) {
        return new ProcessorStatusTableScan(getCluster(), table, processorStatusTable, fields);
    }

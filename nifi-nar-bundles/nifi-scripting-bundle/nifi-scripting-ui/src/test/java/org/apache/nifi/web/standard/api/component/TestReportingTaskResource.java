...
public class TestReportingTaskResource extends JerseyTest {
    ...
    protected Application configure() {
        ...
        config.register(ReportingTaskResource.class);
    ...
    @Test
    public void testSetReportingTaskProperties() {
        ...
        final Response response = client().target(getBaseUri())
                .path("/standard/reporting-task/properties")
                .queryParam("reportingTaskId", "1")
    ...
    @Test
    public void testGetReportingTaskDetails() {
        final NiFiWebConfigurationContext nifiWebConfigurationContext = mock(NiFiWebConfigurationContext.class);
        ...
        final ComponentDetails componentDetails = new ComponentDetails.Builder().name("my-script").type("org.apache.nifi.reporting.script.ScriptedReportingTask")
        ...
        final JsonNode value = client().target(getBaseUri())
                .path("/standard/reporting-task/details")
                .queryParam("reportingTaskId", "1")
                .request()
                .get(JsonNode.class);

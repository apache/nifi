...
<!--Local Libraries-->
<script type="text/javascript" src="js/codemirror/mode/clojure.js"></script>
<script type="text/javascript" src="js/codemirror/mode/groovy.js"></script>
<script type="text/javascript" src="js/codemirror/mode/lua.js"></script>
<script type="text/javascript" src="js/codemirror/mode/python.js"></script>
<script type="text/javascript" src="js/codemirror/mode/ruby.js"></script>
...
<script type="text/javascript" src="app/components/reportingtask/reportingtask.service.js"></script>
<script type="text/javascript" src="app/components/controllerservice/controllerservice.service.js"></script>
...
<script type="text/javascript" src="app/scriptedcomponent/scriptedcomponent.state.js"></script>
<script type="text/javascript" src="app/scriptedcomponent/scriptedcomponent.controller.js"></script>
<script type="text/javascript" src="app/scriptedcomponent/scriptedcomponent.factory.js"></script>

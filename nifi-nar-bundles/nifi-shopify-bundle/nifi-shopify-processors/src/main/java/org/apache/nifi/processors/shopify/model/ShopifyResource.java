...
public class ShopifyResource implements DescribedValue, Resource {
    ...
    public static ShopifyResource newInstance(final String value, final String displayName, final String description, final IncrementalLoadingParameter incrementalLoadingParameter) {
        return new ShopifyResource(value, displayName, description, RestUriType.API, incrementalLoadingParameter);
    }

    public static ShopifyResource withUriPath(final String value, final String displayName, final String description, final RestUriType restUriType,
                                              final IncrementalLoadingParameter incrementalLoadingParameter) {
        return new ShopifyResource(value, displayName, description, restUriType, incrementalLoadingParameter);
    }

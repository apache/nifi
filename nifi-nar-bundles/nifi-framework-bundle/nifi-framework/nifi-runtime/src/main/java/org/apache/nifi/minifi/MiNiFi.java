...
public class MiNiFi implements NiFiEntryPoint {

    private static final Logger logger = LoggerFactory.getLogger(MiNiFi.class);
    private final NiFiServer minifiServer;
    ...
    public MiNiFi(final NiFiProperties properties)
        ...
        Constructor<?> minifiServerConstructor = minifiServerClass.getConstructor(NiFiProperties.class, Set.class);

        final long startTime = System.nanoTime();
        minifiServer = (NiFiServer) minifiServerConstructor.newInstance(properties, narBundles);
        minifiServer.setExtensionMapping(extensionMapping);
        minifiServer.setBundles(systemBundle, narBundles);

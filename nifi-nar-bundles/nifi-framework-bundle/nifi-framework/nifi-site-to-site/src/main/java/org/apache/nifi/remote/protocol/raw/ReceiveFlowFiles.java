...
class ReceiveFlowFiles extends StreamFlowFiles {

    ReceiveFlowFiles(InetSocketAddress serverAddress,
    ...
    protected FlowFileRequest startStreaming(ServerProtocol protocol, Peer peer) {
        return protocol.getPort().startReceivingFlowFiles(peer, protocol);
    }
}

...
public final class FlowRegistryClientContextFactory {
    ...
    public static FlowRegistryClientUserContext getContextForUser(final NiFiUser user) {
        return user.isAnonymous() ? getAnonymousContext() : new StandardFlowRegistryClientUserContext(user.getIdentity());
    }
}

...
final class StandardFlowRegistryClientUserContext implements FlowRegistryClientUserContext {
    ...
    StandardFlowRegistryClientUserContext() {
        niFiUserIdentity = Optional.empty();
    }

    StandardFlowRegistryClientUserContext(final String niFiUserIdentity) {
        this.niFiUserIdentity = Optional.of(niFiUserIdentity);
    }

    @Override
    public Optional<String> getNiFiUserIdentity() {
        return niFiUserIdentity;
    }
}

...
/**
 * This strategy allows to replace the already acquired flow resource if the available is newer, based on the modification time.
 *
 ...
 */
public final class ReplaceWithNewerResolutionStrategy implements FlowResourceConflictResolutionStrategy {

...
public class RegistryTest {
    ...
    public void testScenario1_Test() throws Exception {
        ...
        /*VariableRegistry variableRegistry = () -> {
            ...
            map.put(new VariableDescriptor("SourceDirectory"),"hdfs://172.16.96.132:8020/tmp/nifistateless/input");
            map.put(new VariableDescriptor("SourceFile"),"test.txt");
            map.put(new VariableDescriptor("DestinationDirectory"),"hdfs://172.16.96.132:8020/tmp/nifistateless/output");
            return map;
        };
        StatelessFlow flow = new StatelessFlow("http://172.16.96.132:61080","bucket1","HDFS_to_HDFS", variableRegistry);

        flow.runOnce();

        String outputFile = "/tmp/nifistateless/output2/test2.txt";

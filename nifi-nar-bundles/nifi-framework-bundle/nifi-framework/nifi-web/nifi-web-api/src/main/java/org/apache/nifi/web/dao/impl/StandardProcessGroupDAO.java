...
public class StandardProcessGroupDAO extends ComponentDAO implements ProcessGroupDAO {
    ...
    @Override
    public Set<ProcessGroup> getProcessGroups(final String parentGroupId, final ProcessGroupRecursivity processGroupUpdateStrategy) {
        ProcessGroup group = locateProcessGroup(flowController, parentGroupId);
        if (processGroupUpdateStrategy == ProcessGroupRecursivity.ALL_DESCENDANTS) {

...
class StandardNiFiServiceFacadeSpec extends Specification {
    ...
    def "Test REST API Prometheus Metrics Endpoint"() {
        ...
        // output port
        output.contains("nifi_component_state{instance=\"ABC\",component_type=\"OutputPort\",component_name=\"out\",component_id=\"9876\",parent_id=\"1234\",state=\"Disabled\",} 0.0")
        output.contains("nifi_component_state{instance=\"ABC\",component_type=\"OutputPort\",component_name=\"out\",component_id=\"9876\",parent_id=\"1234\",state=\"Invalid\",} 0.0")
        output.contains("nifi_component_state{instance=\"ABC\",component_type=\"OutputPort\",component_name=\"out\",component_id=\"9876\",parent_id=\"1234\",state=\"Running\",} 0.0")
        output.contains("nifi_component_state{instance=\"ABC\",component_type=\"OutputPort\",component_name=\"out\",component_id=\"9876\",parent_id=\"1234\",state=\"Stopped\",} 1.0")
        output.contains("nifi_component_state{instance=\"ABC\",component_type=\"OutputPort\",component_name=\"out\",component_id=\"9876\",parent_id=\"1234\",state=\"Transmitting\",} 0.0")
        output.contains("nifi_component_state{instance=\"ABC\",component_type=\"OutputPort\",component_name=\"out\",component_id=\"9876\",parent_id=\"1234\",state=\"Validating\",} 0.0")
        ...
        output.contains("nifi_jvm_heap_non_max{instance=\"ABC\",}")

        // repository metrics
        output.contains("nifi_repository_used_bytes{instance=\"ABC\",identifier=\"default\",repository_type=\"provenance\",} 555.0")
        output.contains("nifi_repository_used_bytes{instance=\"ABC\",identifier=\"default\",repository_type=\"content\",} 333.0")
        output.contains("nifi_repository_used_bytes{instance=\"ABC\",identifier=\"flowFile\",repository_type=\"flowfile\",} 111.0")
        output.contains("nifi_repository_max_bytes{instance=\"ABC\",identifier=\"default\",repository_type=\"provenance\",} 666.0")
        output.contains("nifi_repository_max_bytes{instance=\"ABC\",identifier=\"default\",repository_type=\"content\",} 444.0")
        output.contains("nifi_repository_max_bytes{instance=\"ABC\",identifier=\"flowFile\",repository_type=\"flowfile\",} 222.0")

        // thread metrics
        output.contains("nifi_max_timer_driven_threads{instance=\"ABC\",} 10.0")
        output.contains("nifi_max_event_driven_threads{instance=\"ABC\",} 1.0")
        output.contains("nifi_jvm_thread_count{instance=\"ABC\",}")
        output.contains("nifi_jvm_deadlocked_thread_count{instance=\"ABC\",}")

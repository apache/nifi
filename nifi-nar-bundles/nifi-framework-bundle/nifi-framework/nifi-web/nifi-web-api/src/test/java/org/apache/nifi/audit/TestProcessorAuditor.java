...
class TestProcessorAuditor {
    ...
    private static final BundleCoordinate BUNDLE_COORDINATE = new BundleCoordinate("org.apache.nifi", "nifi-dummy-nar", "0.0.0");
    ...
    private ProcessorDTO getProcessorDto() {
        ...
        processorDto.setType("DummyProcessor");
        final BundleDTO bundleDto = new BundleDTO();
        bundleDto.setArtifact("nifi-dummy-nar");
        bundleDto.setGroup("org.apache.nifi");
        bundleDto.setVersion("0.0.0");

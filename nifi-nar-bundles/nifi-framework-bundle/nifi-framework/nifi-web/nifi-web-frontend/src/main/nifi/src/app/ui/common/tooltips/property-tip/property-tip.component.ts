...
export class PropertyTip {
    ...
    formatControllerService(descriptor: PropertyDescriptor): string {
        const formattedType: string = this.nifiCommon.formatType({
            type: descriptor.identifiesControllerService,
            bundle: descriptor.identifiesControllerServiceBundle
        });
        const formattedBundle: string = this.nifiCommon.formatBundle(descriptor.identifiesControllerServiceBundle);

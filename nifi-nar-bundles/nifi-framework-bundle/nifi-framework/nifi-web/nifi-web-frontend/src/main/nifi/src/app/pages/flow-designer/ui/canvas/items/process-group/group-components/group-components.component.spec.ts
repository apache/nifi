...
describe('GroupComponents', () => {
    ...
    let fixture: ComponentFixture<GroupComponents>;

    const data: GroupComponentsDialogRequest = {
        request: {
            moveComponents: [
                {
                    ...
                    entity: {
                        ...
                        component: {
                            id: 'd90ac264-018b-1000-1827-a86c8156fd9e',
                            versionedComponentId: 'cdcf4e70-dac8-3efa-9f5b-75dff5a57317',
                                        ...
                                        allowableValues: [
                                            {
                                                allowableValue: {
                                                    ...
                                                    value: 'GSSAPI',
                                                    description:
                                                        'General Security Services API for Kerberos authentication'
                                                },
                                                canRead: true
                                            },
                                            {
                        ...
                        status: {
                            ...
                            name: 'ConsumeKafka_2_6',
                            runStatus: 'Invalid',
                            statsLastRefreshed: '09:17:11 EST',
                            aggregateSnapshot: {
                                id: 'd90ac264-018b-1000-1827-a86c8156fd9e',
                                groupId: '95a4b210-018b-1000-772a-5a9ebfa03287',
                                name: 'ConsumeKafka_2_6',

        ...
        <div class="setting" style="margin-bottom: 0px;">
            ...
            <div class="setting-field">
                <div id="fill-color-processor-preview">
                    ...
                    <div id="fill-color-processor-preview-name" style="margin-left: 35px; line-height: 25px; font-size: 12px; height: 25px; color: #262626;"><fmt:message key="partials.canvas.fill-color-dialog.ProcessorName"/></div>

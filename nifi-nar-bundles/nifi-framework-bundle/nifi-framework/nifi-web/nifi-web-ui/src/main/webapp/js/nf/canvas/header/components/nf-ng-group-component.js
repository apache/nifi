...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        define(['jquery',
            ...
            function ($, client, birdseye, graph, canvas, errorHandler) {
                return (nf.ng.GroupComponent = factory($, client, birdseye, graph, canvas, errorHandler));
            });
    ...
    return function (serviceProvider) {
        ...
        var createGroup = function (groupName, pt) {
            ...
            return $.ajax({
                type: 'POST',
                url: serviceProvider.headerCtrl.toolboxCtrl.config.urls.api + '/process-groups/' + encodeURIComponent(canvas.getGroupId()) + '/process-groups',

        ...
        if (nfCanvas.SUPPORTS_SVG) {
            ...
            userXhr.done(function () {
                ...
                $.when(configXhr, userXhr, clientXhr).done(function (configResult) {
                    ...
                    nfControllerService.init(nfControllerServices, nfReportingTask, nfFlowAnalysisRule);

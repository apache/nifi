                ...
                <div class="settings-right">
                    <div class="setting">
                        <div class="setting-name">
                            Rule Type
                            <div class="fa fa-question-circle" alt="Info" title="The type of the flow analysis rule."></div>
                        </div>
                        <div class="flow-analysis-rule-editable setting-field">
                            <div id="flow-analysis-rule-type-combo"></div>
                        </div>
                        <div class="flow-analysis-rule-read-only setting-field hidden">
                            <span id="read-only-flow-analysis-rule-type"></span>
                        </div>
                    </div>
                </div>
                <div class="clear"></div>

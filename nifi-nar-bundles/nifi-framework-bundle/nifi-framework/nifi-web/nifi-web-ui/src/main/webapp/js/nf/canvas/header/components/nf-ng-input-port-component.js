...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        define(['jquery',
            ...
            function ($, client, birdseye, graph, canvas, errorHandler) {
                return (nf.ng.InputPortComponent = factory($, client, birdseye, graph, canvas, errorHandler));
            });
    ...
    return function (serviceProvider) {
        ...
        var createInputPort = function (portName, pt) {
            ...
            $.ajax({
                type: 'POST',
                url: serviceProvider.headerCtrl.toolboxCtrl.config.urls.api + '/process-groups/' + encodeURIComponent(canvas.getGroupId()) + '/input-ports',

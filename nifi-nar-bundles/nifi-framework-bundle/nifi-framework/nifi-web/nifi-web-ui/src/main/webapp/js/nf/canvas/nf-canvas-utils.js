    ...
    var nfCanvasUtils = {
        ...
        showDeepLink: function (forceCanvasLoad) {
            ...
            if ('URLSearchParams' in window) {
                ...
                nfDialog.showOkDialog({
                    headerText: 'Deep Linking',
                    dialogContent: 'URLSearchParams API is not supported.'
                });
            }
        },
        ...
        setURLParameters: function (groupId, selections) {
            ...
            if ('URLSearchParams' in window) {
                ...
                var newUrl = url.origin + url.pathname + '?' + $.param(paramsObject);

                if (newUrl.length <= nfCanvasUtils.MAX_URL_LENGTH) {

    ...
    var initializeRemoteSourcePort = function (groupId, groupName, source) {
        return $.Deferred(function (deferred) {
            $.ajax({
                ...
                $('#read-only-connection-source-group div.setting-name').text('Remote NiFi Instance');
    ...
    var initializeDestinationRemotePort = function (groupId, groupName, destination) {
        return $.Deferred(function (deferred) {
            $.ajax({
                ...
                $('#read-only-connection-target-group div.setting-name').text('Remote NiFi Instance');

  ...
  (function (root, factory) {
      ...
      var initControllerServices = function (serviceTable, showSettings) {
            ...
            var moreControllerServiceDetails = function (row, cell, value, columnDef, dataContext) {
              ...
              var markup = '<div class="pointer view-controller-service fa fa-info-circle" title="'+nf._.msg('nf-controller-services.viewDtails')+'" style="margin-top: 5px; margin-right: 3px;" ></div>';
    
                // always include a button to view the usage
              markup += '<div title="'+nf._.msg('nf-controller-services.usage')+'" class="pointer controller-service-usage fa fa-book" style="margin-top: 5px; margin-right: 3px;" ></div>';

...
<div id="settings" class="hidden">
    ...
    <div id="settings-refresh-container">
        ...
        <div id="controller-cs-availability" class="hidden">Listed services are available to all Reporting Tasks, Parameter Providers, and services defined in the Controller Settings.</div>
        <div class="clear"></div>
    </div>
</div>

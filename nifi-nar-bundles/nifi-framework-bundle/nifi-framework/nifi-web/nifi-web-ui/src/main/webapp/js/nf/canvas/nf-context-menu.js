...
(function (root, factory) {
    ...
    var menuItems = [
        ...
        {separator: true},
        {id: 'align-menu-item', groupMenuItem: {clazz: 'icon icon-align--horizontal-left', text: 'Align'}, menuItems: [
            {id: 'align-horizontal-left-menu-item', condition: canAlign, menuItem: { clazz: 'icon icon-align--horizontal-left', text: 'Horizontal Align Left', action: 'alignHorizontalLeft'}},
            {id: 'align-horizontal-center-menu-item', condition: canAlign, menuItem: { clazz: 'icon icon-align--horizontal-center', text: 'Horizontal Align Center', action: 'alignHorizontalCenter'}},
            {id: 'align-horizontal-right-menu-item', condition: canAlign, menuItem: { clazz: 'icon icon-align--horizontal-right', text: 'Horizontal Align Right', action: 'alignHorizontalRight'}},
            {id: 'align-vertical-top-menu-item', condition: canAlign, menuItem: {clazz: 'icon icon-align--vertical-top', text: 'Vertical Align Top', action: 'alignVerticalTop'}},
            {id: 'align-vertical-center-menu-item', condition: canAlign, menuItem: {clazz: 'icon icon-align--vertical-center', text: 'Vertical Align Center', action: 'alignVerticalCenter'}},
            {id: 'align-vertical-bottom-menu-item', condition: canAlign, menuItem: {clazz: 'icon icon-align--vertical-bottom', text: 'Vertical Align Bottom', action: 'alignVerticalBottom'}},
        ]},
        {id: 'distribute-menu-item', groupMenuItem: {clazz: 'icon icon-distribute--vertical-top', text: 'Distribute'}, menuItems: [
            {id: 'distribute-vertical-top-menu-item', condition: canDistribute, menuItem: {clazz: 'icon icon-distribute--vertical-top', text: 'Vertical Distribute Top', action: 'distributeVerticalTop'}},
            {id: 'distribute-vertical-center-menu-item', condition: canDistribute, menuItem: {clazz: 'icon icon-distribute--vertical-center', text: 'Vertical Distribute Center', action: 'distributeVerticalCenter'}},
            {id: 'distribute-vertical-bottom-menu-item', condition: canDistribute, menuItem: {clazz: 'icon icon-distribute--vertical-bottom', text: 'Vertical Distribute Bottom', action: 'distributeVerticalBottom'}},
            {id: 'distribute-horizontal-left-menu-item', condition: canDistribute, menuItem: {clazz: 'icon icon-distribute--horizontal-left', text: 'Horizontal Distribute Left', action: 'distributeHorizontalLeft'}},
            {id: 'distribute-horizontal-center-menu-item', condition: canDistribute, menuItem: {clazz: 'icon icon-distribute--horizontal-center', text: 'Horizontal Distribute Center', action: 'distributeHorizontalCenter'}},
            {id: 'distribute-horizontal-right-menu-item', condition: canDistribute, menuItem: {clazz: 'icon icon-distribute--horizontal-right', text: 'Horizontal Distribute Right', action: 'distributeHorizontalRight'}},
        ]},

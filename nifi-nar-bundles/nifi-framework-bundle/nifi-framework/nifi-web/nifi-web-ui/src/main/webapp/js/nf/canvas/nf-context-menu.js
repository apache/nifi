...
(function (root, factory) {
    ...
    var menuItems = [
        ...
        {separator: true},
        {id: 'enable-all-controllers-menu-item', condition: isProcessGroup, menuItem: {clazz: 'fa fa-flash', text: 'Enable all controllers', action: 'enableAllControllers'}},
        {id: 'enable-all-controllers-menu-item-noselection', condition: emptySelection, menuItem: {clazz: 'fa fa-flash', text: 'Enable all controllers', action: 'enableAllControllers'}},
        {id: 'disable-all-controllers-menu-item', condition: isProcessGroup, menuItem: {clazz: 'icon icon-enable-false', text: 'Disable all controllers', action: 'disableAllControllers'}},
        {id: 'disable-all-controllers-menu-item-noselection', condition: emptySelection, menuItem: {clazz: 'icon icon-enable-false', text: 'Disable all controllers', action: 'disableAllControllers'}},
        {separator: true},

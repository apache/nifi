...
nf.SummaryTable = (function () {
    ...
    var initSummaryTable = function (isClustered) {
        ...
        var moreProcessorDetails = function (row, cell, value, columnDef, dataContext) {
            var markup = '<div title="View Details" class="pointer show-processor-details fa fa-info-circle" style="margin-top: 5px; float: left;"></div>';
        ...
        var runStatusFormatter = function (row, cell, value, columnDef, dataContext) {
            ...
            var formattedValue = '<div class="' + classes + '" style="margin-top: 5px;"></div>';
        ...
        if (isClustered || isInShell || nf.Common.SUPPORTS_SVG) {
            ...
            var processorActionFormatter = function (row, cell, value, columnDef, dataContext) {
                ...
                if (isInShell) {
                    markup += '<div class="pointer go-to fa fa-long-arrow-right" title="Go To" style="margin-top: 2px;"></div>&nbsp;';
                }

                if (nf.Common.SUPPORTS_SVG) {
                    markup += '<div class="pointer show-processor-status-history fa fa-area-chart" title="Show History" style="margin-top: 2px;"></div>&nbsp;';
                }

                if (isClustered) {
                    markup += '<div class="pointer show-cluster-processor-summary fa fa-icon-cubes" title="Show Details" style="margin-top: 2px;"></div>&nbsp;';
                }
        ...
        if (isClustered || isInShell || nf.Common.SUPPORTS_SVG) {
            ...
            var connectionActionFormatter = function (row, cell, value, columnDef, dataContext) {
                ...
                if (nf.Common.SUPPORTS_SVG) {
                    markup += '<div class="pointer show-connection-status-history fa fa-area-chart" title="Show History" style="margin-top: 2px;"></div>&nbsp;';
                }

                if (isClustered) {
                    markup += '<div class="pointer show-cluster-connection-summary fa fa-icon-cubes" title="Show Details" style="margin-top: 2px;"></div>&nbsp;';
                }
        ...
        if (isClustered || isInShell || nf.Common.SUPPORTS_SVG) {
            ...
            var processGroupActionFormatter = function (row, cell, value, columnDef, dataContext) {
                ...
                if (nf.Common.SUPPORTS_SVG) {
                    markup += '<div class="pointer show-process-group-status-history fa fa-area-chart" title="Show History" style="margin-top: 2px;"></div>&nbsp;';
                }

                if (isClustered) {
                    markup += '<div class="pointer show-cluster-process-group-summary fa fa-icon-cubes" title="Show Details" style="margin-top: 2px;"></div>&nbsp;';
                }
        ...
        if (isClustered || isInShell) {
            ...
            var inputPortActionFormatter = function (row, cell, value, columnDef, dataContext) {
                ...
                if (isClustered) {
                    markup += '<div class="pointer show-cluster-input-port-summary fa fa-icon-cubes" title="Show Details" style="margin-top: 2px;"></div>&nbsp;';
                }
        ...
        if (isClustered || isInShell) {
            ...
            var outputPortActionFormatter = function (row, cell, value, columnDef, dataContext) {
                ...
                if (isClustered) {
                    markup += '<div class="pointer show-cluster-output-port-summary fa fa-icon-cubes" title="Show Details" style="margin-top: 2px;"></div>&nbsp;';
                }
        ...
        if (isClustered || isInShell || nf.Common.SUPPORTS_SVG) {
            ...
            var remoteProcessGroupActionFormatter = function (row, cell, value, columnDef, dataContext) {
                ...
                if (nf.Common.SUPPORTS_SVG) {
                    markup += '<div class="pointer show-remote-process-group-status-history fa fa-area-chart" title="Show History" style="margin-top: 2px;"></div>&nbsp;';
                }

                if (isClustered) {
                    markup += '<div class="pointer show-cluster-remote-process-group-summary fa fa-icon-cubes" title="Show Details" style="margin-top: 2px;"></div>&nbsp;';
                }

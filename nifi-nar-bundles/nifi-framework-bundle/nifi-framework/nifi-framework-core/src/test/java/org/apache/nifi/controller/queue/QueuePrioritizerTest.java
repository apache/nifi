...
class QueuePrioritizerTest {
    ...
    void deprioritizesFlowFilesWithPenalty() {
        ...
        assertEquals(-1, prioritizer.compare(nonPenalizedFlowFile, longerPenalizedFlowFile));        assertEquals(1, prioritizer.compare(longerPenalizedFlowFile, nonPenalizedFlowFile));

...
public class TestStandardPropertyValue {
    ...
    private final VariableRegistry variableRegistry = VariableRegistryUtils.createVariableRegistry();
    ...
    public void testSystemProperty() {
        ...
        final PropertyValue value = new StandardPropertyValue("${Prop1}${Prop2}${abc}", lookup, VariableRegistryUtils.createVariableRegistry());
        final Map<String, String> attributes = new HashMap<>();

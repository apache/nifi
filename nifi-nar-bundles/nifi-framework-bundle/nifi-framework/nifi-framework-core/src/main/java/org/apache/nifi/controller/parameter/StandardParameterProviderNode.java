...
public class StandardParameterProviderNode extends AbstractParameterProviderNode implements ParameterProviderNode {

    private final FlowController flowController;

    public StandardParameterProviderNode(final LoggableComponent<ParameterProvider> parameterProvider, final String id, final FlowController controller,
        ...
        super(parameterProvider, id, controller.getControllerServiceProvider(), validationContextFactory, variableRegistry, reloadComponent, extensionManager, validationTrigger);
    ...
    public StandardParameterProviderNode(final LoggableComponent<ParameterProvider> parameterProvider, final String id, final FlowController controller,
        ...
        super(parameterProvider, id, controller.getControllerServiceProvider(), validationContextFactory, componentType, canonicalClassName,

...
public class StandardContentClaimWriteCache implements ContentClaimWriteCache {
    ...
    public OutputStream write(final ContentClaim claim) throws IOException {
        ...
        if (!(claim instanceof CachableContentClaim)) {
            // we know that we will only create Content Claims that are of type CachableContentClaim, so if we get anything
        ...
        final CachableContentClaim scc = (CachableContentClaim) claim;

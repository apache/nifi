...
public interface StatusHistoryStorage {
    ...
    void storeNodeStatuses(final Collection<NodeStatus> statuses);
    void storeGarbageCollectionStatuses(final Collection<GarbageCollectionStatus> statuses);
    void storeProcessGroupStatuses(final Collection<ProcessGroupStatus> statuses);
    void storeConnectionStatuses(final Collection<ConnectionStatus> statuses);
    void storeRemoteProcessorGroupStatuses(final Collection<RemoteProcessGroupStatus> statuses);
    void storeProcessorStatuses(final Collection<ProcessorStatus> statuses);
}

...
public class StatelessReloadComponent implements ReloadComponent {
    ...
    @Override
    public void reload(FlowAnalysisRuleNode flowAnalysisRule, String canonicalClassName, BundleCoordinate incomingCoordinate, Set<URL> additionalUrls) throws FlowAnalysisRuleInstantiationException {

...
public class StatelessProcessContextFactory implements ProcessContextFactory {
    ...
    public StatelessProcessContextFactory(final ControllerServiceProvider controllerServiceProvider, final StringEncryptor encryptor, final StateManagerProvider stateManagerProvider) {

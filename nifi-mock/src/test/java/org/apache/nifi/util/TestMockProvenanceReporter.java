...
public class TestMockProvenanceReporter {

    @Test
    public void testFlowFileAcquisitionMethodSetOnReceiveFetch() {
        final DummyProcessor processor = new DummyProcessor();
        ...
        final MockProvenanceReporter provenanceReporter = new MockProvenanceReporter(session, sharedSessionState, "fooId", "fooType");

        final FlowFile flowFile = session.createFlowFile("lorem ipsum".getBytes());

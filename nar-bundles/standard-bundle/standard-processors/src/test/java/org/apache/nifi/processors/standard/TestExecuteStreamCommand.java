...
public class TestExecuteStreamCommand {
    ...
    public void testExecuteIngestAndUpdate() throws IOException {
        ...
        assertTrue(result.contains(File.separator + "standard-processors:ModifiedResult\r\n")
                || result.contains(File.separator + "standard-processors:ModifiedResult\n"));
    }
    ...
    public void testExecuteIngestAndUpdateWithWorkingDir() throws IOException {
        ...
        byte[] byteArray = flowFiles.get(0).toByteArray();
        String result = new String(byteArray);
        assertTrue(result.contains(File.separator + "standard-processors" + File.separator + "target:ModifiedResult\r\n")
                || result.contains(File.separator + "standard-processors" + File.separator + "target:ModifiedResult\n"));
    }

...
public class FnProcessSession implements ProcessSession {
    ...
    public FnProcessSession(final Queue<FnFlowFile> input, final Collection<ProvenanceEventRecord> events, final Processor processor, final Set<Relationship> outputRelationships,

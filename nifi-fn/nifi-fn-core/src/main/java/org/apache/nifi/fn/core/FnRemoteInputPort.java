...
public class FnRemoteInputPort extends AbstractFnComponent {
    private final Queue<FnFlowFile> inputQueue = new LinkedList<>();
    private final SiteToSiteClient client;
    private final String name;
    private final String url;

    private final ComponentLog logger = new SLF4JComponentLog(this);
    private final FnConnectionContext connectionContext = new FnConnectionContext() {
        @Override
    ...
    public FnRemoteInputPort(final VersionedRemoteProcessGroup rpg, final VersionedRemoteGroupPort remotePort, final SSLContext sslContext) {

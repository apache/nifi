...
public class BatchTest {
    ...
    public void testScenario1_Test() throws Exception {
        ...
        // Build Flow
        ///////////////////////////////////////////
        FnProcessorWrapper getFile = new FnProcessorWrapper(UUID.randomUUID().toString(), new GetFile(), null, serviceLookup, registry, materializeData, ClassLoader.getSystemClassLoader());
        ...
        FnProcessorWrapper splitText = wrapProcessor(new SplitText(), serviceLookup, registry);
        ...
        FnProcessorWrapper replaceText = wrapProcessor(new ReplaceText(), serviceLookup, registry);
        ...
        FnProcessorWrapper putFile = wrapProcessor(new PutFile(), serviceLookup, registry);
    ...
    private FnProcessorWrapper wrapProcessor(final Processor processor, FnControllerServiceLookup serviceLookup, final VariableRegistry registry)
                throws InvocationTargetException, IllegalAccessException {
        return new FnProcessorWrapper(UUID.randomUUID().toString(), processor, null, serviceLookup, registry, true, ClassLoader.getSystemClassLoader());
    }
}
...
public class JavaAction {
    ...
    //wsk action create nifistateless NiFiStateless/target/NiFi-Stateless-1.0-SNAPSHOT.jar --main org.apache.nifi.stateless.runtimes.OpenWhisk.JavaAction#OpenWhiskJavaEntry
    //wsk action invoke -br nifistateless -p registryurl http://172.0.0.1:61080 -p bucket e53b8a0d-5c85-4fcd-912a-1c549a586c83 -p flow 6cf8277a-c402-4957-8623-0fa9890dd45d -p variable1 val1 -p variable2 val2
    public static JsonObject OpenWhiskJavaEntry(JsonObject args) {

        JsonObject result = new JsonObject();
        try {
            StatelessFlow flow = StatelessFlow.createAndEnqueueFromJSON(args);

...
public class StatelessConnectionDTO implements StatelessConnection {

    private final ConnectionDTO connection;

    public StatelessConnectionDTO(final ConnectionDTO connection) {
    ...
    public StatelessConnectable getSource() {
        return new StatelessConnectableDTO(this.connection.getSource());
    }

    @Override
    public StatelessConnectable getDestination() {
        return new StatelessConnectableDTO(this.connection.getDestination());
    }
}

...
|`nifi.registry.security.user.oidc.client.id`                        | The Client ID for NiFi registered with the OpenID Connect Provider
|`nifi.registry.security.user.oidc.client.secret`                    | The Client Secret for NiFi registered with the OpenID Connect Provider

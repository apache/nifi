...
public class BundleVersionDependencyEntityRowMapper implements RowMapper<BundleVersionDependencyEntity> {
    ...
    @Override
    public BundleVersionDependencyEntity mapRow(final ResultSet rs, final int i) throws SQLException {
        final BundleVersionDependencyEntity entity = new BundleVersionDependencyEntity();
        entity.setId(rs.getString("ID"));
        entity.setExtensionBundleVersionId(rs.getString("BUNDLE_VERSION_ID"));

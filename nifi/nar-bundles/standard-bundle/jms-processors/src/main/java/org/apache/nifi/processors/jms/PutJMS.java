...
import static org.apache.nifi.processors.jms.util.JmsFactory.ATTRIBUTE_PREFIX;
import static org.apache.nifi.processors.jms.util.JmsFactory.ATTRIBUTE_TYPE_SUFFIX;
import static org.apache.nifi.processors.jms.util.JmsFactory.PROP_TYPE_BOOLEAN;
import static org.apache.nifi.processors.jms.util.JmsFactory.PROP_TYPE_BYTE;
import static org.apache.nifi.processors.jms.util.JmsFactory.PROP_TYPE_DOUBLE;
import static org.apache.nifi.processors.jms.util.JmsFactory.PROP_TYPE_FLOAT;
import static org.apache.nifi.processors.jms.util.JmsFactory.PROP_TYPE_INTEGER;
import static org.apache.nifi.processors.jms.util.JmsFactory.PROP_TYPE_LONG;
import static org.apache.nifi.processors.jms.util.JmsFactory.PROP_TYPE_OBJECT;
import static org.apache.nifi.processors.jms.util.JmsFactory.PROP_TYPE_SHORT;
import static org.apache.nifi.processors.jms.util.JmsFactory.PROP_TYPE_STRING;
import static org.apache.nifi.processors.jms.util.JmsProperties.ATTRIBUTES_TO_JMS_PROPS;
...
import static org.apache.nifi.processors.jms.util.JmsProperties.DESTINATION_TYPE;
import static org.apache.nifi.processors.jms.util.JmsProperties.JMS_PROVIDER;
import static org.apache.nifi.processors.jms.util.JmsProperties.MAX_BUFFER_SIZE;
import static org.apache.nifi.processors.jms.util.JmsProperties.MESSAGE_PRIORITY;
import static org.apache.nifi.processors.jms.util.JmsProperties.MESSAGE_TTL;
import static org.apache.nifi.processors.jms.util.JmsProperties.MESSAGE_TYPE;
import static org.apache.nifi.processors.jms.util.JmsProperties.MSG_TYPE_BYTE;
import static org.apache.nifi.processors.jms.util.JmsProperties.MSG_TYPE_EMPTY;
import static org.apache.nifi.processors.jms.util.JmsProperties.MSG_TYPE_STREAM;
import static org.apache.nifi.processors.jms.util.JmsProperties.MSG_TYPE_TEXT;
import static org.apache.nifi.processors.jms.util.JmsProperties.PASSWORD;
import static org.apache.nifi.processors.jms.util.JmsProperties.REPLY_TO_QUEUE;
...
import org.apache.nifi.processors.jms.util.WrappedMessageProducer;

...
class TestObjectLocalTimeFieldConverter {
    ...
    void testDefaultFormatterIterationFallsBackToNumericParse() {
        // Validates the continue branch inside ObjectLocalTimeFieldConverter.convertField (lines 88-94) that steps through
        // DEFAULT_TIME_FORMATTERS before the numeric fallback is attempted.

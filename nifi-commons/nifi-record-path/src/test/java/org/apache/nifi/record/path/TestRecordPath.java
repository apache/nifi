...
public class TestRecordPath {
    ...
    public void testToDateFromString() {
        ...
        assertTrue(RecordPath.compile("toDateWithTimeZone(/date, \"yyyy-MM-dd'T'HH:mm:ss'Z'\", \"GMT+8:00\")").evaluate(record).getSelectedFields().findFirst().get().getValue() instanceof Date);
    }
    ...
    public void testToDateFromLong() throws ParseException {
        ...
        assertTrue(RecordPath.compile("toDateWithTimeZone(/date, \"yyyy-MM-dd'T'HH:mm:ss'Z'\", \"GMT+8:00\")").evaluate(record).getSelectedFields().findFirst().get().getValue() instanceof Long);
    }
    ...
    public void testToDateFromNonDateString() {
        ...
        assertEquals("John Doe", fieldValue.getValue());
        final FieldValue fieldValue2 = RecordPath.compile("toDateWithTimeZone(/name, \"yyyy-MM-dd'T'HH:mm:ss'Z'\", \"GMT+8:00\")").evaluate(record).getSelectedFields().findFirst().get();
    ...
    public void testFormatDateFromString() throws ParseException {
        ...
        final FieldValue fieldValue2 = RecordPath.compile("formatWithTimeZone( toDate(/date, \"yyyy-MM-dd'T'HH:mm:ss'Z'\"), 'yyyy-MM-dd' , 'GMT+8:00')")
        ...
        final FieldValue fieldValueUnchanged2 = RecordPath.compile("formatWithTimeZone( toDate(/date, \"yyyy-MM-dd'T'HH:mm:ss'Z'\"), 'INVALID' , 'INVALID')")
            .evaluate(record).getSelectedFields().findFirst().get();
    ...
    public void testFormatDateFromLong() throws ParseException {
        ...
        assertEquals("2017-10-20 08:00:00", RecordPath.compile("formatWithTimeZone(/date, 'yyyy-MM-dd HH:mm:ss', 'GMT+8:00' )").evaluate(record).getSelectedFields().findFirst().get().getValue());
        ...
        final FieldValue fieldValueUnchanged2 = RecordPath.compile("formatWithTimeZone(/date, 'INVALID', 'INVALID' )").evaluate(record).getSelectedFields().findFirst().get();
    ...
    public void testFormatDateWhenNotDate() {
        ...
        assertEquals("John Doe", RecordPath.compile("formatWithTimeZone(/name, 'yyyy-MM', 'GMT+8:00')").evaluate(record).getSelectedFields().findFirst().get().getValue());
    }

...
public class EncryptionMethodException extends RuntimeException {
    public EncryptionMethodException(final String message) {
        super(message);
    }
     ...
     */
    public EncryptionMethodException(final String message, final Throwable cause) {
        super(message, cause);
    }
}

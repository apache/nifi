...
public enum EncryptionMethod {
    ...
    MD5_192AES("PBEWITHMD5AND192BITAES-CBC-OPENSSL", "BC", false, false),
    MD5_256AES("PBEWITHMD5AND256BITAES-CBC-OPENSSL", "BC", false, false),
    ...
    SHA_128AES("PBEWITHSHAAND128BITAES-CBC-BC", "BC", true, false),
    SHA_192AES("PBEWITHSHAAND192BITAES-CBC-BC", "BC", true, false),
    SHA_256AES("PBEWITHSHAAND256BITAES-CBC-BC", "BC", true, false),
    SHA_40RC2("PBEWITHSHAAND40BITRC2-CBC", "BC", true, false),
    SHA_128RC2("PBEWITHSHAAND128BITRC2-CBC", "BC", true, false),
    SHA_40RC4("PBEWITHSHAAND40BITRC4", "BC", true, false),
    SHA_128RC4("PBEWITHSHAAND128BITRC4", "BC", true, false),
    SHA256_128AES("PBEWITHSHA256AND128BITAES-CBC-BC", "BC", true, false),
    SHA256_192AES("PBEWITHSHA256AND192BITAES-CBC-BC", "BC", true, false),
    SHA256_256AES("PBEWITHSHA256AND256BITAES-CBC-BC", "BC", true, false),
    SHA_2KEYTRIPLEDES("PBEWITHSHAAND2-KEYTRIPLEDES-CBC", "BC", true, false),
    SHA_3KEYTRIPLEDES("PBEWITHSHAAND3-KEYTRIPLEDES-CBC", "BC", true, false),
    SHA_TWOFISH("PBEWITHSHAANDTWOFISH-CBC", "BC", true, false),

...
class BcryptCipherProviderGroovyTest {
    ...
    void testGetCipherShouldSupportExternalCompatibility() throws Exception {
        ...
        final byte[] SALT = new Radix64Encoder.Default().decode("QAQzuIk/j2wqJbHiLSsBA.".bytes)
        final byte[] IV = Hex.decodeHex("a0b7bb8269dcf2b245e8998ac334718b" as char[])

        // $v2$w2$base64_salt_22__base64_hash_31
        final String FULL_HASH = "\$2a\$10\$QAQzuIk/j2wqJbHiLSsBA.TGV9gQ3GQxQtRJVEzfvwY/cic3cNeEW"
        ...
        final String CIPHER_TEXT = "1575074d52bec8212ea5a0bab203f5aca644102c30b9582909432553428df4be"
        ...
        def rubyKey = new SecretKeySpec(Hex.decodeHex("43a76ac4e23606268de24228d09cf429" as char[]), "AES")
    ...
    void testGetCipherShouldHandleFullSalt() throws Exception {
        ...
        final byte[] IV = Hex.decodeHex("57b017f9c0fdf8f0341424477e6baac1" as char[])

        // $v2$w2$base64_salt_22__base64_hash_31
        final String FULL_HASH = "\$2a\$10\$9XUQnxGEUsRdLqEhxY3xNujOQQkW3spKqxssi.Ox39VhhxB.z4496"
        logger.info("Full Hash: ${FULL_HASH}")
        final String FULL_SALT = FULL_HASH[0..<29]
        ...
        final String CIPHER_TEXT = "e51fee301593cc06b3112a7b9a16ab71be113c47d2b17cccc1b31a6e3b5a1631"
        byte[] cipherBytes = Hex.decodeHex(CIPHER_TEXT as char[])

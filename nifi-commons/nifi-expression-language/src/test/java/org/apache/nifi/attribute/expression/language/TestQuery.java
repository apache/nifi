...
public class TestQuery {
    ...
    public void testDecimalMathOperations() {
        ...
        verifyEquals("${exactOne:toDecimal()}", attributes, 1D);
        verifyEquals("${one:toNumber()}", attributes, 1L);
    ...
    public void testDecimalLogicOperations() {
        ...
        /*verifyEquals("${one:toNumber()}",attributes, 1);//(${two})}", attributes, true);

...
GREATER_THAN_DECIMAL	: 'gtDecimal';
LESS_THAN_DECIMAL		: 'ltDecimal';
GREATER_THAN_OR_EQUAL_DECIMAL	: 'geDecimal';
LESS_THAN_OR_EQUAL_DECIMAL		: 'leDecimal';
...
DIVIDE : 'divide';
TO_RADIX : 'toRadix';
MOD_DECIMAL : 'modDecimal';
PLUS_DECIMAL : 'plusDecimal';
MINUS_DECIMAL : 'minusDecimal';
MULTIPLY_DECIMAL : 'multiplyDecimal';
DIVIDE_DECIMAL : 'divideDecimal';
MATH: 'math';
OR : 'or';
AND : 'and';
JOIN : 'join';

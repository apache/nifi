...
oneArgString : ((SUBSTRING_BEFORE | SUBSTRING_BEFORE_LAST | SUBSTRING_AFTER | SUBSTRING_AFTER_LAST | REPLACE_NULL | REPLACE_EMPTY | REPLACE_BY_PATTERN |
				PREPEND | APPEND | STARTS_WITH | ENDS_WITH | CONTAINS | PLUS_DURATION | PLUS_INSTANT_DURATION | MINUS_DURATION | MINUS_INSTANT_DURATION | UNIQUE | COMPACT_DELIMITED_LIST | TRIM_DELIMITED_LIST | JOIN | JSON_PATH | JSON_PATH_DELETE | FROM_RADIX | UUID3 | UUID5 | HASH) LPAREN! anyArg RPAREN!) |

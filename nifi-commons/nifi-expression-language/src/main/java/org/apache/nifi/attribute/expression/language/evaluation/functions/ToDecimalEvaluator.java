...
public class ToDecimalEvaluator extends DecimalEvaluator {

    private final Evaluator<String> subject;

    public ToDecimalEvaluator(final Evaluator<String> subject) {
    ...
    public QueryResult<Double> evaluate(final Map<String, String> attributes) {
        ...
        return new DecimalQueryResult(subjectValue == null || subjectValue.trim().isEmpty() ? null : Double.valueOf(subjectValue));
    }

...
public class GreaterThanOrEqualDecimalEvaluator extends BooleanEvaluator {

    private final Evaluator<Double> subject;
    private final Evaluator<Double> comparison;

    public GreaterThanOrEqualDecimalEvaluator(final Evaluator<Double> subject, final Evaluator<Double> comparison) {

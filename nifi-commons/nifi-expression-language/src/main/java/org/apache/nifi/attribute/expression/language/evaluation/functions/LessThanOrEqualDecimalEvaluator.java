...
public class LessThanOrEqualDecimalEvaluator extends BooleanEvaluator {

    private final Evaluator<Double> subject;
    private final Evaluator<Double> comparison;

    public LessThanOrEqualDecimalEvaluator(final Evaluator<Double> subject, final Evaluator<Double> comparison) {

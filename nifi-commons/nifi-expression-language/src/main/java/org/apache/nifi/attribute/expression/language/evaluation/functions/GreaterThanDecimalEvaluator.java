...
public class GreaterThanDecimalEvaluator extends BooleanEvaluator {

    private final Evaluator<Double> subject;
    private final Evaluator<Double> comparison;

    public GreaterThanDecimalEvaluator(final Evaluator<Double> subject, final Evaluator<Double> comparison) {

...
public class MultiValueLookup implements ValueLookup {
    ...
    MultiValueLookup(final VariableRegistry registry, final FlowFile flowFile, final Map<String, String>... additionalMaps) {

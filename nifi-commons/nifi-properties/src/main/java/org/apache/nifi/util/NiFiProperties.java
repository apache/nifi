...
public abstract class NiFiProperties {
    ...
    public static final String WEB_HTTPS_INCLUDE_CIPHERSUITES = "nifi.web.https.includeciphersuites";
    public static final String WEB_HTTPS_EXCLUDE_CIPHERSUITES = "nifi.web.https.excludeciphersuites";

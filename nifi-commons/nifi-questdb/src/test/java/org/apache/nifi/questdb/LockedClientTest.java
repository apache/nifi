...
public class LockedClientTest {
    ...
    public void testLockIsReleasedAfterExceptionWhenCompile() {
        ...
        Assertions.assertThrows(ConditionFailedException.class, () -> testSubject.execute(SELECT_QUERY));
    ...
    public void testLockIsReleasedAfterExceptionWhenInsertEntries() {
        ...
        Assertions.assertThrows(ConditionFailedException.class, () -> testSubject.insert(EVENT_TABLE_NAME, InsertRowDataSource.forMapping(EVENT_TABLE_INSERT_MAPPING, Collections.emptyList())));
        Assertions.assertEquals(0, lock.getReadLockCount());
    }
    ...
    public void testLockIsReleasedAfterExceptionWhenQueryEntries() {
        ...
        Assertions.assertThrows(ConditionFailedException.class, () -> testSubject.query(SELECT_QUERY, QueryResultProcessor.forMapping(QuestDbTestUtil.EVENT_TABLE_REQUEST_MAPPING)));
        Assertions.assertEquals(0, lock.getReadLockCount());
    }
    ...
    public void testCompileWhenUnsuccessfulLockingBecauseOfReadLock() throws InterruptedException {
        ...
        lockLatch.await();
        Assertions.assertThrows(LockUnsuccessfulException.class, () -> testSubject.execute(SELECT_QUERY));
    }
    ...
    public void testInsertWhenUnsuccessfulLockingBecauseOfReadLock() throws InterruptedException {
        ...
        lockLatch.await();
        Assertions.assertThrows(LockUnsuccessfulException.class, () -> testSubject.insert(EVENT_TABLE_NAME, InsertRowDataSource.forMapping(EVENT_TABLE_INSERT_MAPPING, Collections.emptyList())));
    }
    ...
    public void testQueryWhenUnsuccessfulLockingBecauseOfReadLock() throws InterruptedException {
        ...
        lockLatch.await();
        Assertions.assertThrows(LockUnsuccessfulException.class, () -> testSubject.query(SELECT_QUERY, QueryResultProcessor.forMapping(QuestDbTestUtil.EVENT_TABLE_REQUEST_MAPPING)));
    }

    private static void executeQueryOnDifferentThread(final Client testSubject) {
        new Thread(() -> {
            try {
                testSubject.query(SELECT_QUERY, QueryResultProcessor.forMapping(QuestDbTestUtil.EVENT_TABLE_REQUEST_MAPPING));
    ...
    private void executeInsertOnDifferentThread(final Client testSubject) {
        new Thread(() -> {
            try {
                testSubject.insert(EVENT_TABLE_NAME, InsertRowDataSource.forMapping(EVENT_TABLE_INSERT_MAPPING, Collections.emptyList()));
            } catch (DatabaseException e) {
                Assertions.fail();
            }
        }).start();

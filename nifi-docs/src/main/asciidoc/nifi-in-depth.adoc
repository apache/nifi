...
image:images/zero-master-node.png["NiFi Architecture Diagram"]
...
image:images/WebCrawler.png["Web Crawler Flow"]
...
image:images/DataIngress.png["Data Ingress"]
...
image:images/PassByReference.png["Pass By Reference"]
...
image:images/Funnels.png["Funnel"]
...
image:images/CopyOnWrite.png["Copy On Write"]
...
image:images/UpdatingAttributes.png["Updating Attributes"]

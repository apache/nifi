...
*Description*: [.description]#Returns the installation directory of NIFI.#
...
*Examples*: The installation directory of NIFI can be obtained by using the Expression `${NIFI_HOME()}`.

...
*Special Cases*: If the subject is null, returns null. If the delimiter is null or empty, returns the original subject unchanged. Empty values are preserved (e.g., "a,,b,,c" becomes "a,,b,c").

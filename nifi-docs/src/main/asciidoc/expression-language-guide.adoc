...
*Description*: [.description]#Returns an HTML-friendly version of the Subject. This is useful, for instance, when using an
	attribute value that may contain HTML-escaped characters.#
...
*Examples*: We can HTML-Encode an attribute named "text" by using the Expression `${text:htmlEncode()}`. If
	the value of the "text" attribute is "here is an &", this
	Expression will then return "here is an \&amp;".
...
*Description*: [.description]#Returns an HTML-decoded version of the Subject. This is useful, for instance, when using an
	attribute value that may contain HTML characters.#
...
*Examples*: We can HTML-Decode an attribute named "text" by using the Expression `${text:htmlDecode()}`. If
	the value of the "text" attribute is "here is an \&amp;", this
	Expression will then return "here is an &".

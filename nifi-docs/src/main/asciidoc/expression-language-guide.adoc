...
- *Decimal*: A Decimal is a numeric value that can support decimals and larger values with minimal loss of precision. More precisely it
    ...
    refer to this https://docs.oracle.com/javase/specs/jls/se7/html/jls-4.html#jls-4.2.3[link]. Decimals cannot be expressed as literals
    when inputting an Expression Language function. They be input as Strings using single quotes, like so: '1.1'.
...
[.function]
=== gtDecimal
*Description*: [.description]#The `gt` function is used for the comparison of Decimals and returns `true` if the subject is Greater Than
	its argument. If either the subject or the argument cannot be coerced into a Decimal,
	this function returns `false`.#

*Subject Type*: [.subject]#Decimal#

*Arguments*:

	- [.argName]#_value_# : [.argDesc]#The Decimal to compare the Subject to.#

*Return Type*: [.returnType]#Boolean#

*Examples*: `${decimalValue:gtDecimal( '1.1' )}` will return `true` if value in the decimalValue attribute is greater than '1.1'.
...
[.function]
=== geDecimal
*Description*: [.description]#The `ge` function is used for the comparison of Decimals and returns `true` if the subject is Greater Than
	Or Equal To its argument. If either the subject or the argument cannot be coerced into a Decimal,
	this function returns `false`.#
...
*Examples*: `${decimalValue:geDecimal( '1.1' )}` will return `true` if the value in the decimalValue attribute is at least (
	is greater than or equal to) '1.1'. Otherwise, it will return `false`.



[.function]
=== ltDecimal
*Description*: [.description]#The `lt` function is used for the comparison of Decimals and returns `true` if the subject is Less Than
	its argument. If either the subject or the argument cannot be coerced into a Decimal,
	this function returns `false`.#
...
*Examples*: `${decimalValue:ltDecimal( '1.1' )}` will return `true` if the size of the FlowFile's content is less than
	1 megabyte (1048576 bytes). Otherwise, it will return `false`.
...
*Examples*: `${fileSize:leDecimal( 1048576 )}` will return `true` if the size of the FlowFile's content is at most
	(less than or equal to) 1 megabyte (1048576 bytes). Otherwise, it will return `false`.
...
*Description*: [.description]#Divides the Subject by a numeric value and returns the result, rounded down to the nearest integer.#
...
*Description*: [.description]#Adds a decimal value to the Subject. If either the argument or the Subject cannot be
	coerced into a Decimal, returns `null`.#
...
*Examples*: If the "decimalValue" attribute has a value of 0.4123, then the Expression `${decimalValue:plusDecimal('0.123')}`
	will return the value `0.5353`.
...
*Description*: [.description]#Subtracts a decimal value from the Subject.#
...
*Examples*: If the "decimalValue" attribute has a value of 0.4123, then the Expression `${decimalValue:minusDecimal('0.4123')}`
...
*Description*: [.description]#Multiplies a decimal value by the Subject and returns the product.#
...
*Examples*: If the "decimalValue" decimalValue has a value of 0.4123, then the Expression `${fileSize:multiplyDecimal('2.5')}`
	will return the value `1.03075`.
...
*Description*: [.description]#Divides the Subject by a decimal value and returns the result.#
...
*Examples*: If the "decimalValue" attribute has a value of 0.4123, then the Expression `${fileSize:divide('1.5')}`
	will return the value `0.27486666666666665`.
...
*Examples*: The Expression `${fileSize:toDecimal()}` converts the String attribute value of "fileSize" to a decimal.

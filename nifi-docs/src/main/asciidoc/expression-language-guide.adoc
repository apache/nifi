...
check out the FlowFile section of the <<developer-guide.adoc#flowfile,Developer's Guide>>.
...
*Description*: [.description]#The `isValidInstant` function returns `true` when the Subject can be parsed as a valid ISO-8601 instant or RFC-1123 date-time, and `false` otherwise.
This function is useful for validating values before calling `toInstant()`. Unlike `toInstant()`, this function does not throw an error when parsing fails.#
...
.isValidInstant Examples
|===================================================================
| Expression | Value
| `${eventTime:isValidInstant()}` where `eventTime` = `2026-08-04T10:15:30Z` | `true`
| `${eventTime:isValidInstant()}` where `eventTime` = `2026-08-04T10:15:30+05:30` | `true`
| `${eventTime:isValidInstant()}` where `eventTime` = `Tue, 04 Aug 2026 10:15:30 GMT` | `true`
| `${eventTime:isValidInstant()}` where `eventTime` = `not-a-date` | `false`
| `${eventTime:isValidInstant():ifElse('valid-instant', 'invalid-instant')}` where `eventTime` = `2026-08-04T10:15:30Z` | `valid-instant`
|===================================================================
...
*Description*: [.description]#The `isValidDate` function returns `true` when the Subject can be parsed as a valid date using the specified format and optional timezone, and `false` otherwise.
Validation is calendar-aware, so values that match the format pattern but do not represent a real date, such as `31-02-2026`, return `false`.
This function is useful for validating values before calling `toDate()`. Unlike `toDate()`, this function does not throw an error when parsing fails.#

*Subject Type*: [.subject]#String#

*Arguments*:

- *format* (required): The date format to use for parsing. The format must be a valid `java.time.format.DateTimeFormatter` pattern, such as `dd-MM-yyyy`.
- *timezone* (optional): The timezone to apply when resolving date-time fields, such as `UTC` or `America/New_York`. When not provided, the system default timezone is used.

*Return Type*: [.returnType]#Boolean#

.isValidDate Examples
|===================================================================
| Expression | Value
| `${myDate:isValidDate('dd-MM-yyyy')}` where `myDate` = `04-08-2026` | `true`
| `${myDate:isValidDate('dd-MM-yyyy')}` where `myDate` = `31-02-2026` | `false`
| `${myDate:isValidDate('dd-MM-yyyy')}` where `myDate` = `not-a-date` | `false`
| `${myDate:isValidDate('yyyy-MM-dd HH:mm:ss', 'UTC')}` where `myDate` = `2026-08-04 10:15:30` | `true`
| `${myDate:isValidDate('dd-MM-yyyy'):ifElse('valid', 'invalid')}` where `myDate` = `04-08-2026` | `valid`
|===================================================================
...
*Description*: [.description]#Splits the Subject using the specified delimiter, removes all empty tokens, and rejoins the remaining tokens using the same delimiter.
...
- [.argName]#_delimiter_# : [.argDesc]#The delimiter used to split and rejoin the Subject.
This may be a single character or a multi-character string.#

*Return Type*: [.returnType]#String#

*Examples*: If the "my_list" attribute contains the value `,,a,,b,,c,`, the "tags"
...
*Description*: [.description]#Splits the Subject using the specified delimiter, removes leading
...
behaves similarly to `trim()`, but operates on delimited token boundaries rather
...
*Description*: [.description]#Returns the unique values from a delimited string while preserving the order of first occurrence. The function takes a delimiter as an argument and returns the deduplicated values joined by the same delimiter.#

*Subject Type*: [.subject]#String#

*Arguments*:

- [.argName]#_delimiter_# : [.argDesc]#The delimiter used to split and join the subject string#

*Return Type*: [.returnType]#String#

*Examples*: If the "tags" attribute has the value "red,blue,red,green,blue,yellow", then the following
...
If the "paths" attribute has the value "C:\Users\test;D:\Data;C:\Users\test;E:\Backup", then:
...
*Special Cases*: If the subject is null, returns an empty string. If the delimiter is null or empty, returns the original subject unchanged. Empty values are preserved (e.g., "a,,b,,c" becomes "a,,b,c").
...
| `${str:repeat(1, ${str:length()})}` | `abc` or `abcabc` or `abcabcabc` (at random)
|================================================================
...
*Description*: [.description]#Adds a specified amount of time to a Date value using a human-readable expression such as `"1 week"` or `"3 months"`. Month and year adjustments follow calendar rules.#
...
- [.argName]#_amount_# : [.argDesc]#A string in the form `"<number> <unit>"`. A space between the number and unit is required.#
- [.argName]#_timezone_# (optional) : [.argDesc]#A timezone ID string (e.g. `"America/New_York"`, `"Europe/Vienna"`). When provided, calendar-unit arithmetic (days, weeks, months, years) is performed in the specified timezone so that wall-clock time is preserved across DST boundaries. When omitted, the JVM system default timezone is used.#

*Supported Units*: nanosecond(s), second(s), minute(s), hour(s), day(s), week(s), month(s), year(s)

Units are case-insensitive.

NOTE: Nanoseconds are accepted but have no effect on a `Date` subject because `java.util.Date` has millisecond precision. Use `plusInstantDuration` if nanosecond precision is required.

*Return Type*: [.returnType]#Date#

*Examples*: If the "date" attribute has the value `"04-08-2026"` (August 4, 2026), then the following Expressions will result in the following values:

.plusDuration Examples
|============================================================================
| Expression | Value
| `${date:toDate('dd-MM-yyyy'):plusDuration('1 week'):format('dd-MM-yyyy')}` | `11-08-2026`
| `${date:toDate('dd-MM-yyyy'):plusDuration('2 years'):format('dd-MM-yyyy')}` | `04-08-2028`
| `${date:toDate('dd-MM-yyyy'):plusDuration('3 months'):format('dd-MM-yyyy')}` | `04-11-2026`
| `${date:toDate('dd-MM-yyyy'):plusDuration('2 hours'):format('dd-MM-yyyy HH:mm:ss')}` | `04-08-2026 02:00:00`
| `${date:toDate('dd-MM-yyyy'):plusDuration('1 day')}` | Returns the epoch milliseconds for the resulting Date.
| `${date:toDate('yyyy-MM-dd HH:mm:ss', 'Europe/Vienna'):plusDuration('1 day', 'Europe/Vienna'):format('yyyy-MM-dd HH:mm:ssXXX', 'Europe/Vienna')}` (where date = `"2026-03-29 00:00:00"`) | `2026-03-30 00:00:00+02:00` (DST-aware: wall-clock time preserved across spring-forward)
|============================================================================
...
| DST spring-forward (with timezone) | Mar 29 00:00:00 CET + 1 day (Europe/Vienna) | Mar 30 00:00:00 CEST
|============================================================================
...
*Description*: [.description]#Subtracts a specified amount of time from a Date value using a human-readable expression such as `"1 week"` or `"3 months"`. Month and year adjustments follow calendar rules.#
...
NOTE: Nanoseconds are accepted but have no effect on a `Date` subject because `java.util.Date` has millisecond precision. Use `minusInstantDuration` if nanosecond precision is required.
...
|============================================================================
| Expression | Value
| `${date:toDate('dd-MM-yyyy'):minusDuration('1 month'):format('dd-MM-yyyy')}` | `04-07-2026`
| `${date:toDate('dd-MM-yyyy'):minusDuration('2 weeks'):format('dd-MM-yyyy')}` | `21-07-2026`
| `${date:toDate('dd-MM-yyyy'):minusDuration('1 year'):format('dd-MM-yyyy')}` | `04-08-2025`
| `${date:toDate('dd-MM-yyyy'):minusDuration('1 second'):format('dd-MM-yyyy HH:mm:ss')}` | `03-08-2026 23:59:59`
| `${date:toDate('dd-MM-yyyy'):minusDuration('1 day')}` | Returns the epoch milliseconds for the resulting Date.
| `${date:toDate('yyyy-MM-dd HH:mm:ss', 'America/New_York'):minusDuration('1 day', 'America/New_York'):format('yyyy-MM-dd HH:mm:ssXXX', 'America/New_York')}` (where date = `"2026-11-02 00:00:00"`) | `2026-11-01 00:00:00-04:00` (DST-aware: wall-clock time preserved across fall-back)
|============================================================================
...
| DST fall-back (with timezone) | Nov 2 00:00:00 EDT - 1 day (America/New_York) | Nov 1 00:00:00 EDT
|============================================================================
...
*Description*: [.description]#Adds a specified amount of time to an Instant value using a human-readable expression such as `"1 week"` or `"3 months"`. Arithmetic is evaluated in UTC.#
...
*Examples*: If the "date" attribute has the value `"04-08-2026 00:00:00"`, then the following Expressions will result in the following values:

.plusInstantDuration Examples
|============================================================================
| Expression | Value
| `${date:toInstant('dd-MM-yyyy HH:mm:ss', 'UTC'):plusInstantDuration('1 week'):formatInstant('dd-MM-yyyy HH:mm:ss', 'UTC')}` | `11-08-2026 00:00:00`
| `${date:toInstant('dd-MM-yyyy HH:mm:ss', 'UTC'):plusInstantDuration('2 years'):formatInstant('dd-MM-yyyy HH:mm:ss', 'UTC')}` | `04-08-2028 00:00:00`
| `${date:toInstant('dd-MM-yyyy HH:mm:ss', 'UTC'):plusInstantDuration('3 months'):formatInstant('dd-MM-yyyy HH:mm:ss', 'UTC')}` | `04-11-2026 00:00:00`
| `${date:toInstant('dd-MM-yyyy HH:mm:ss', 'Australia/Sydney'):plusInstantDuration('3 months'):formatInstant('dd-MM-yyyy HH:mm:ss', 'Australia/Sydney')}` | `04-11-2026 01:00:00`
|============================================================================
...
*Description*: [.description]#Subtracts a specified amount of time from an Instant value using a human-readable expression such as `"1 week"` or `"3 months"`. Arithmetic is evaluated in UTC.#
...
|============================================================================
| Expression | Value
| `${date:toInstant('dd-MM-yyyy HH:mm:ss', 'UTC'):minusInstantDuration('1 week'):formatInstant('dd-MM-yyyy HH:mm:ss', 'UTC')}` | `28-07-2026 00:00:00`
| `${date:toInstant('dd-MM-yyyy HH:mm:ss', 'UTC'):minusInstantDuration('2 years'):formatInstant('dd-MM-yyyy HH:mm:ss', 'UTC')}` | `04-08-2024 00:00:00`
| `${date:toInstant('dd-MM-yyyy HH:mm:ss', 'UTC'):minusInstantDuration('3 months'):formatInstant('dd-MM-yyyy HH:mm:ss', 'UTC')}` | `04-05-2026 00:00:00`
| `${date:toInstant('dd-MM-yyyy HH:mm:ss', 'Australia/Sydney'):minusInstantDuration('3 months'):formatInstant('dd-MM-yyyy HH:mm:ss', 'Australia/Sydney')}` | `04-05-2026 00:00:00`
|============================================================================

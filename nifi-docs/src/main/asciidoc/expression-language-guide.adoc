...
The Subject is expected to be a Number that represents the number of milliseconds since Midnight GMT on January 1, 1970 or a String with one of the following
...
*Subject Type*: [.subject]#Number or Date/Time#

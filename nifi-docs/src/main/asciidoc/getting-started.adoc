...
To get started, open a web browser and navigate to link:https://localhost:9443/nifi[`https://localhost:9443/nifi`^]. The port can be changed by
editing the `nifi.properties` file in the NiFi `conf` directory, but the default port is 9443.

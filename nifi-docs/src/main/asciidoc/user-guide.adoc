...
NOTE: By default each new connection added will have a default FlowFile Expiration Period of `0 mins`. This default can be changed by modifying the nifi.queue.flowfile.expiration.period property in the _nifi.properties_ file.

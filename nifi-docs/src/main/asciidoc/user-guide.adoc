...
Also, you can expose any Input Port in child Process Groups so that it can receive data remotely via Site-to-Site protocol by enabling its "Allow Remote Access".

...
protocol, though, is the NiFi Site-to-Site Protocol. Site-to-Site makes it easy to transfer data from one NiFi cluster to
another NiFi cluster (or other consuming application) easily, efficiently, and securely.

...
protocol, though, is the NiFi Site-to-Site Protocol. Site-to-Site makes it easy to securely and efficiently transfer data from nodes in one NiFi instance to
nodes in another NiFi instance or other consuming application.

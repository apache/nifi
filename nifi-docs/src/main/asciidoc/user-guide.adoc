...
will process an entire batch of data (which will either be a a single FlowFile or many FlowFiles depending on the FlowFile Concurrency) as a coherent batch of data.

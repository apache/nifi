...
|access restricted components     |Allows users to create/modify restricted components assuming otherwise sufficient permissions. The restricted components
may indicate which specific permissions are required. Permissions can be granted for each specific restriction or be granted regardless of restrictions.
If permissions is granted regardless of restrictions, this means the user can create/modify all restricted components.

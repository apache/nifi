...
* `--skip` parameter, configuring how to handle existing flow and flow version creation.
...
* Import all flow versions:
 ...
 ./bin/cli.sh registry import-all-flows -u http://localhost:18080 --input "/my_dir/flow_exports" --skip false
...
5. Import versions
 ...
 ./bin/cli.sh registry import-all-flows -u http://localhost:18080 --input "/my_dir/flow_exports" --skip true
...
2. Import versions:
 ...
 ./bin/cli.sh registry import-all-flows -u http://nifi-registry-2:18080 --input "/my_dir/flow_exports" --skip false

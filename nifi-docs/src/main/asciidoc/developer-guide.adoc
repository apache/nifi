...
The most common attributes you'll see are filename, path and uuid.
...
- Alternative Identifier: Indicates an identifier other than the FlowFile's UUID that is known to refer to this FlowFile.

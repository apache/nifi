...
guide, you have a basic understanding of NiFi and the concepts of dataflow. If not, please see the link:overview.adoc[NiFi Overview]
and the link:user-guide.adoc[NiFi User Guide] to familiarize yourself with the concepts of NiFi.

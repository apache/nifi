...
The following non-number types are also accepted if they can be coerced to a number:
...
Coerces a String or Date value to a number. If the argument is already a number it is returned unmodified, preserving the original type.
...
| `subtract('2.0', 2)` | 0.0
| `subtract(/flags, 2)` | 5
| `subtract(2, /temp)` | -53.0
| `subtract(/load, /temp)` | -49.33
|==============================================================================

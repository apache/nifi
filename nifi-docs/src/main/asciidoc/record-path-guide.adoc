...
Converts a String using Base64 encoding, using the UTF-8 character set.  For example, given a schema such as:
...
Decodes a Base64-encoded String.  For example, given a schema such as:

...
Converts a String to a date with given time zone.  For example, given a schema such as:
...
----
{
  ...
  "name": "events",
  "fields": [
    { "name": "dt_str", "type": "string" },
    { "name": "dt_long", "type" : { "type" : "long", "logicalType" : "timestamp-millis" } }
  ]
}
----
...
The following record path would parse the eventDate field into a Date in given time zone:

|==========================================================
| RecordPath | Return value
| `toDateWithTimeZone( /dt_str, "yyyy-MM-dd HH:mm:ss", "GMT+8:00")` | -28800000
|==========================================================
...
Converts a Date to a String in the given format with given time zone.

The first argument to this function must be a Date or a Number, and the second argument must be a format String that
follows the Java SimpleDateFormat, and the third argument must be a format String that 
...
|==========================================================
| RecordPath | Return value
| `formatWithTimeZone( /dt_long, "yyyy-MM-dd HH:mm:ss Z", "GMT+8:00")` | 1970-01-01 08:00:00 +0800 
| `formatWithTimeZone( /dt_long, "yyyy-MM-dd", "GMT+8:00")` | 1970-01-01 
|==========================================================

...
public class XmlBxmlNodeVisitor implements BxmlNodeVisitor {
    ...
    public XmlBxmlNodeVisitor(final XMLStreamWriter xmlStreamWriter, final RootNode rootNode) throws IOException {
        this.xmlStreamWriter = xmlStreamWriter;
        substitutions = rootNode.getSubstitutions();
        for (final BxmlNode bxmlNode : rootNode.getChildren()) {
            bxmlNode.accept(this);
        }
    }

    @Override
    public void visit(final OpenStartElementNode openStartElementNode) throws IOException {
        try {
            xmlStreamWriter.writeStartElement(openStartElementNode.getTagName());
            try {
                final List<BxmlNode> nonAttributeChildren = new ArrayList<>();
                for (final BxmlNode bxmlNode : openStartElementNode.getChildren()) {
                ...
                for (final BxmlNode nonAttributeChild : nonAttributeChildren) {
    ...
    @Override
    public void visit(final AttributeNode attributeNode) throws IOException {
        try {
            final AttributeNodeVisitor attributeNodeVisitor = new AttributeNodeVisitor();
    ...
    @Override
    public void visit(final TemplateInstanceNode templateInstanceNode) throws IOException {
        templateInstanceNode.getTemplateNode().accept(this);
    }

    @Override
    public void visit(final TemplateNode templateNode) throws IOException {
        for (final BxmlNode bxmlNode : templateNode.getChildren()) {
            bxmlNode.accept(this);
        }
    }

    @Override
    public void visit(final RootNode rootNode) throws IOException {
        new XmlBxmlNodeVisitor(xmlStreamWriter, rootNode);
    }

    @Override
    public void visit(final CDataSectionNode cDataSectionNode) throws IOException {
        try {
    ...
    @Override
    public void visit(final EntityReferenceNode entityReferenceNode) throws IOException {
        try {
    ...
    @Override
    public void visit(final ValueNode valueNode) throws IOException {
        for (final BxmlNode bxmlNode : valueNode.getChildren()) {
            bxmlNode.accept(this);
        }
    }

    @Override
    public void visit(final ConditionalSubstitutionNode conditionalSubstitutionNode) throws IOException {
        substitutions.get(conditionalSubstitutionNode.getIndex()).accept(this);
    }

    @Override
    public void visit(final NormalSubstitutionNode normalSubstitutionNode) throws IOException {
        substitutions.get(normalSubstitutionNode.getIndex()).accept(this);
    }

    @Override
    public void visit(final VariantTypeNode variantTypeNode) throws IOException {
        try {

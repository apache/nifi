...
public class FlowConfigHistoryDataSource implements ResettableDataSource {
    ...
    private Object[] toArray(final Action action) {
        ...
        return new Object[] {
            ...
            details instanceof final ConfigureDetails configureDetails ? configureDetails.getName() : null,
            details instanceof final ConfigureDetails configureDetails ? configureDetails.getPreviousValue() : null,
            details instanceof final ConfigureDetails configureDetails ? configureDetails.getValue() : null,
            details instanceof final ConnectDetails connectDetails ? connectDetails.getSourceId() : null,
            details instanceof final ConnectDetails connectDetails ? connectDetails.getSourceName() : null,
            details instanceof final ConnectDetails connectDetails ? connectDetails.getSourceType() : null,
            details instanceof final ConnectDetails connectDetails ? connectDetails.getDestinationId() : null,
            details instanceof final ConnectDetails connectDetails ? connectDetails.getDestinationName() : null,
            details instanceof final ConnectDetails connectDetails ? connectDetails.getDestinationType() : null,
            details instanceof final ConnectDetails connectDetails ? connectDetails.getRelationship() : null,
            details instanceof final MoveDetails moveDetails ? moveDetails.getGroup() : null,
            details instanceof final MoveDetails moveDetails ? moveDetails.getGroupId() : null,
            details instanceof final MoveDetails moveDetails ? moveDetails.getPreviousGroup() : null,
            details instanceof final MoveDetails moveDetails ? moveDetails.getPreviousGroupId() : null,
            details instanceof final PurgeDetails purgeDetails ? purgeDetails.getEndDate().getTime() : null
        };
    }
}

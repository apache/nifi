...
public class RecordTestUtil {
    ...
    public static Object convertArray(final Object value) {
        final List<Object> converted = new ArrayList<>();

        final int length = Array.getLength(value);
        for (int index = 0; index < length; index++) {
            final Object itemValue = convertValue(Array.get(value, index));
    ...
    public static Map<String, Object> convertRecord(final Record record) {
        final Map<String, Object> converted = record.toMap().entrySet().stream()
                .map(nameAndValue -> {
                    final Tuple<String, Object> result;
    ...
    public static void assertRecordsEqual(final Record record1, final Record record2) {
        final Map<String, Object> map1 = convertRecord(record1);
        final Map<String, Object> map2 = convertRecord(record2);
    ...
    public static void assertValuesEqual(final String prefix, final Object value1, final Object value2) {
    ...
    public static void assertMapsEqual(final String prefix, final Map<String, Object> map1, final Map<String, Object> map2) {
        ...
        map2.entrySet().stream().forEach(entry -> {
            final String key = entry.getKey();
            final Object value1 = entry.getValue();
            final Object value2 = map1.get(key);

            assertValuesEqual(prefix + "." + key, value2, value1);
        });
    }

    public static void assertListsEqual(final String prefix, final List list1, final List list2) {
        final int length1 = list1.size();
        final int length2 = list2.size();

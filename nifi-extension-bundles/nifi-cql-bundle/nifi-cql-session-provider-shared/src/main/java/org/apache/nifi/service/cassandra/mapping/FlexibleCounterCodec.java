...
/**
 * A CQL {@code counter} codec that binds any {@link Number} by narrowing it to a {@code long} and
 * delegating to the built-in {@code bigint} codec, since a counter is stored as a 64-bit integer.
 */

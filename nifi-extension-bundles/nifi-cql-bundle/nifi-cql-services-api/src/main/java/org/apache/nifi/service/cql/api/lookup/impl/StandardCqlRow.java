...
/**
 * A {@link CqlRow} backed by a fixed cell list; the interface derives every other accessor from
 * {@link #cells()}.
 *
 * @param cells the row's cells in selection order; copied, non-null
 */

...
/**
 * Which part of a table's primary key a column belongs to, on a {@link PrimaryKeyMetadata} or
 * {@link PrimaryKeyIdentifier}. The partition key places a row on a node; clustering columns order rows

...
/**
 * A CQL {@code timestamp} codec that binds {@code java.sql.Timestamp} (what {@code DataTypeUtils} produces
 * for a TIMESTAMP-typed record field) by converting to and from {@link Instant}.
 */

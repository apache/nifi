...
/**
 * A fallback CQL {@code tinyint} codec that accepts any byte-compatible value (a numeric String, a
 * differently-sized {@link Number}), not just an exact {@link Byte}. Declared against {@link Object} so

...
public class PublishKafka_2_6_PartitionStrategyIT extends PublishKafka_2_6_BaseIT {
    ...
    public void test_1_KafkaTestContainerProduceOne() {
        ...
        runner.setProperty(ProducerConfig.PARTITIONER_CLASS_CONFIG, Partitioners.ExpressionLanguagePartitioner.class.getName());
        runner.setProperty("partition", Long.toString(System.currentTimeMillis()));

...
public class PublishKafkaSSLIT {
    ...
    private String addSSLContextService(final TestRunner runner) throws InitializationException {
        ...
        runner.setProperty(service, RestrictedSSLContextService.KEYSTORE, KEYSTORE_PATH);
        runner.setProperty(service, RestrictedSSLContextService.KEYSTORE_PASSWORD, KEYSTORE_PASSWORD);
        runner.setProperty(service, RestrictedSSLContextService.KEYSTORE_TYPE, KeystoreType.JKS.name());
        runner.setProperty(service, RestrictedSSLContextService.TRUSTSTORE, TRUSTSTORE_PATH);
        runner.setProperty(service, RestrictedSSLContextService.TRUSTSTORE_PASSWORD, TRUSTSTORE_PASSWORD);
        runner.setProperty(service, RestrictedSSLContextService.TRUSTSTORE_TYPE, KeystoreType.JKS.name());

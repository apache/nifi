...
public class PublishKafkaAcksOneNodeIT extends AbstractPublishKafkaIT {
    ...
    public void test_1_KafkaTestContainerProduceOne() throws InitializationException {
        ...
        runner.setProperty(PublishKafka.DELIVERY_GUARANTEE, DeliveryGuarantee.DELIVERY_ONE_NODE);

...
public enum AwsRoleSource implements DescribedValue {
    ...
    WEB_IDENTITY_TOKEN("Web Identity Provider", "Obtain AWS MSK IAM credentials from the configured AWS Credentials Provider Service using OAuth2/OIDC web identity federation.");

...
public final class ProtoTestUtil {
    ...
    public static FileDescriptor loadFileDescriptor(final String descriptorFileName) throws IOException, Descriptors.DescriptorValidationException {
    ...
    public static FileDescriptor loadFileDescriptor(final String descriptorFileName, final FileDescriptor[] dependencies)
    ...
    public static FileDescriptor[] loadAllFileDescriptors(final String descriptorFileName) throws IOException, Descriptors.DescriptorValidationException {
        final FileDescriptorSet descriptorSet = FileDescriptorSet.parseFrom(
            new FileInputStream(BASE_TEST_PATH + descriptorFileName));
     ...
     */
    public static DescriptorContainer loadDescriptorContainer(final String descriptorFileName) throws IOException, Descriptors.DescriptorValidationException {
    ...
    public static class DescriptorContainer {
         ...
         */
        public Descriptor findMessageTypeByName(final String messageName) {

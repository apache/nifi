...
class TestUniversalProtobufReader extends UniversalProtobufReaderTestBase {
    ...
    @Test
    void testUniversalProtobufReaderWithTestProto3Schema() throws Exception {
        ...
        final RecordReader recordReader = universalProtobufReader.createRecordReader(emptyMap(), testDataStream, 0L, runner.getLogger());
    ...
    void testCreateRecordReaderWithSchemaReferences() throws Exception {
        ...
        final RecordReader recordReader = universalProtobufReader.createRecordReader(emptyMap(), inputStream, 0L, runner.getLogger());
    ...
    void testValidSchemaDefinitionWithProtoExtension() {
        ...
        universalProtobufReader.validateSchemaDefinitionIdentifiers(validMainSchema);
    }
    ...
    void testRootSchemaIsAllowedToHaveInvalidName() {
        ...
        universalProtobufReader.validateSchemaDefinitionIdentifiers(validSchema);
    }
    ...
    void testValidMainSchemaWithInvalidReferencedSchema() {
        ...
        final IllegalArgumentException referencedException = assertThrows(IllegalArgumentException.class, () -> {
            universalProtobufReader.validateSchemaDefinitionIdentifiers(mixedSchema);
        });
    ...
    void testSchemaDefinitionWithMissingName() {
        ...
        enableAllControllerServices();
        universalProtobufReader.validateSchemaDefinitionIdentifiers(schemaWithoutName);
    }
    ...
    class WithSchemaNamePropertyAccessStrategy {
        ...
        void beforeEach() {
            ...
            runner.setProperty(universalProtobufReader, MESSAGE_NAME, PROTO_3_MESSAGE);

        }

        @Test
        void testUniversalProtobufReaderWithTestProto3Schema() throws Exception {
            runner.setProperty(universalProtobufReader, SCHEMA_NAME, PROTO_3_SCHEMA);
            TestUniversalProtobufReader.this.testUniversalProtobufReaderWithTestProto3Schema();
        }

        @Test
        void testSchemaNotFoundRethrown() {
            TestUniversalProtobufReader.this.testSchemaNotFoundRethrown();
        }

        @Test
        void testCreateRecordReaderWithSchemaReferences() throws Exception {
            runner.setProperty(universalProtobufReader, SCHEMA_NAME, "user_settings");
            TestUniversalProtobufReader.this.testCreateRecordReaderWithSchemaReferences();
        }
    }
    ...
    class WithSchemaTextAccessStrategy {
        ...
        void beforeEach() {
            ...
            runner.setProperty(universalProtobufReader, SCHEMA_TEXT, getTestProto3File());

...
@WritesAttributes({
        @WritesAttribute(attribute = "box.file.id", description = "The ID of the file whose metadata was updated"),
...
public class UpdateBoxFileMetadataTemplate extends AbstractProcessor {
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        try (final InputStream inputStream = session.read(flowFile);
            ...
            try {
                ...
                attributes.put("box.file.id", fileId);
        ...
        } catch (IOException | ProcessException | MalformedRecordException | SchemaNotFoundException e) {

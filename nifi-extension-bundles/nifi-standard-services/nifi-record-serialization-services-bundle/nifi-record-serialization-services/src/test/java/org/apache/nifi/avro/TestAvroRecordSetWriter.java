...
public class TestAvroRecordSetWriter {

    @Test
    void testMigrateProperties() {
        final AvroRecordSetWriter service = new AvroRecordSetWriter();
        final Map<String, String> expectedRenamed = Map.ofEntries(
                Map.entry("compression-format", AvroRecordSetWriter.COMPRESSION_FORMAT.getName()),
                Map.entry("encoder-pool-size", AvroRecordSetWriter.ENCODER_POOL_SIZE.getName()),
                Map.entry("cache-size", AvroRecordSetWriter.CACHE_SIZE.getName()),

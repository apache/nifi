...
public class TestJsonRecordSetWriter {
    ...
    void testMigrateProperties() {
        ...
        final Map<String, String> expectedRenamed = Map.ofEntries(
                Map.entry("suppress-nulls", JsonRecordSetWriter.SUPPRESS_NULLS.getName()),
                Map.entry("output-grouping", JsonRecordSetWriter.OUTPUT_GROUPING.getName()),
                Map.entry("compression-format", JsonRecordSetWriter.COMPRESSION_FORMAT.getName()),
                Map.entry("compression-level", JsonRecordSetWriter.COMPRESSION_LEVEL.getName()),

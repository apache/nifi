...
public class TestSyslog5424Reader {

    @Test
    void testMigrateProperties() {
        final Syslog5424Reader service = new Syslog5424Reader();
        final Map<String, String> expectedRenamed = Map.ofEntries(
                Map.entry("syslog-5424-reader-raw-message", Syslog5424Reader.ADD_RAW.getName()),

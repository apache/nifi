...
class TestMSSQLDatabaseDialectService {
    ...
    void testUpsertMerge() {
        ...
        final String expected = """
                MERGE INTO table AS target USING (VALUES (?, ?, ?, ?)) AS source (column1, column2, column3, column4) \
    ...
    @Test
    void testCreateStatementWithNullableColumns() {
    ...
    @Test
    void testCreateStatementWithQualifiedTableName() {
    ...
    @Test
    void testAlterStatementWithQualifiedTableName() {
    ...
    @Test
    void testUnsupportedStatementType() {
    ...
    @Test
    void testSelectWithDerivedTable() {
    ...
    @Test
    void testSelectWithEmptyColumns() {
    ...
    @Test
    void testPartitionedPagingWithoutLimit() {
        final TableDefinition table = table("database.tablename", columns(sampleColumns(), new boolean[sampleColumns().size()]));
    ...
    @Test
    void testPartitionedPagingWithBlankIndexColumn() {
        final TableDefinition table = table("database.tablename", columns(sampleColumns(), new boolean[sampleColumns().size()]));
    ...
    @Test
    void testUpsertWithAllPrimaryKeyColumns() {
        ...
        final StatementRequest req = upsertReq(table);
        final String expected = """
                MERGE INTO lookup_table AS target USING (VALUES (?, ?)) AS source (key1, key2) \
    ...
    @Test
    void testUpsertValidationEmptyColumns() {
    ...
    @Test
    void testUpsertValidationNoPrimaryKeys() {
    ...
    @Test
    void testSelectWithNonQueryStatementRequest() {
        final List<String> cols = List.of("col1");
        final boolean[] pk = new boolean[]{false};
        final TableDefinition table = table("table", columns(cols, pk));

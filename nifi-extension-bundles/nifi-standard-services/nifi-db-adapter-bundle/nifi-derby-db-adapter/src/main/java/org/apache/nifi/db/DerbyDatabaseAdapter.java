 ...
 */
@Tags({"sql", "database", "syntax", "dialect", "adapter", "derby"})
@CapabilityDescription("Adapter for Derby SQL dialect.")
public class DerbyDatabaseAdapter extends AbstractControllerService implements DatabaseAdapter {

 ...
 */
@Tags({"sql", "database", "syntax", "dialect", "adapter", "mssql", "2012"})
@CapabilityDescription("Adapter for Microsoft SQL 2012+ dialect.")
public class MSSQL2012DatabaseAdapter extends AbstractControllerService implements DatabaseAdapter {
    @Override

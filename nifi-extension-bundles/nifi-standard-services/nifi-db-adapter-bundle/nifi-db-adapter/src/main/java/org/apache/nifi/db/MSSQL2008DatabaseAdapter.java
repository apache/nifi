 ...
 */
@Tags({"sql", "database", "syntax", "dialect", "adapter", "mssql", "2008", "legacy"})
@CapabilityDescription("Adapter for Microsoft SQL 2008 dialect.")
public class MSSQL2008DatabaseAdapter extends MSSQL2012DatabaseAdapter {
    @Override

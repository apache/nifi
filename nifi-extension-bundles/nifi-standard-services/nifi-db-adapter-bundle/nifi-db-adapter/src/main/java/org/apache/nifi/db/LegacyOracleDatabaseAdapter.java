 ...
 */
@Tags({"sql", "database", "syntax", "dialect", "adapter", "oracle", "legacy"})
@CapabilityDescription("Adapter for Legacy Oracle SQL dialect.")
public class LegacyOracleDatabaseAdapter extends AbstractControllerService implements DatabaseAdapter {
    @Override

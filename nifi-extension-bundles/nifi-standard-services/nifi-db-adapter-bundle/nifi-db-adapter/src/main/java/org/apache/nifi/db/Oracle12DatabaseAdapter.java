...
@Tags({"sql", "database", "syntax", "dialect", "adapter", "oracle", "12"})
@CapabilityDescription("Adapter for Oracle 12+ SQL dialect.")
public class Oracle12DatabaseAdapter extends AbstractControllerService implements DatabaseAdapter {
    @Override

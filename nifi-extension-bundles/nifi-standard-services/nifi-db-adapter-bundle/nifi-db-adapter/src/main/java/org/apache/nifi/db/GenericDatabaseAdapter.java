 ...
 */
@Tags({"sql", "database", "syntax", "dialect", "adapter", "generic"})
@CapabilityDescription("Adapter for a generic SQL dialect, that is understood by most databases.")
public class GenericDatabaseAdapter extends AbstractControllerService implements DatabaseAdapter {
    @Override

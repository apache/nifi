 ...
 */
@Tags({"sql", "database", "syntax", "dialect", "adapter"})
@CapabilityDescription("Adapter for a specific SQL dialect.")
public interface DatabaseAdapter extends ControllerService {
     ...
     */
    default String getLiteralByType(int type, String value) {

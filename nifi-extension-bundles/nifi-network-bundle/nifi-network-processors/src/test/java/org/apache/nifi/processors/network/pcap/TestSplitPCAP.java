 ...
 */
 ...
 class TestSplitPCAP {
     ...
     void init() {
         ...
         headerBuffer.put(PCAP.readIntToNBytes(2, 2, false));
         headerBuffer.put(PCAP.readIntToNBytes(4, 2, false));
         headerBuffer.put(PCAP.readIntToNBytes(0, 4, false));
         headerBuffer.put(PCAP.readIntToNBytes(0, 4, false));
         headerBuffer.put(PCAP.readIntToNBytes(4000, 4, false));
         headerBuffer.put(PCAP.readIntToNBytes(1, 4, false));

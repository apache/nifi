...
public class DeleteRowsWriter extends AbstractBinlogTableEventWriter<DeleteRowsEventInfo> {
     ...
     */
    @Override
    public long writeEvent(final ProcessSession session, final String transitUri, final DeleteRowsEventInfo eventInfo, final long currentSequenceId, final Relationship relationship,
    ...
    protected void writeRow(final DeleteRowsEventInfo event, final Serializable[] row, final BitSet includedColumns) throws IOException {

...
public class WrapperRecordStreamPubSubMessageConverter implements PubSubMessageConverter {
            ...
            for (ReceivedMessage message : messages) {
                ...
                try (final InputStream in = new ByteArrayInputStream(payload);
                    ...
                    while (true) {
                        ...
                        final RecordSchema fullSchema = WrapperRecord.toWrapperSchema(recordSchema);
                        ...
                        recordGroup.writer().write(new WrapperRecord(record, message));
                    }

...
public class QueryCassandraIT {
    ...
    public void resetState() {
        ...
        queryCassandraTestRunner.clearQueue();
    }
    ...
    public static void setup() throws InitializationException {
        ...
        putCassandraTestRunner.setValidateExpressionUsage(false);
        queryCassandraTestRunner.setValidateExpressionUsage(false);
        ...
        String createTable = String.format(
                "CREATE TABLE IF NOT EXISTS %s.%s (id int PRIMARY KEY, uuid text, age int);",
                KEYSPACE, TABLE);
    ...
    @Test
    public void testIncomingFlowFileProducesSingleResultFlowFile() {
        ...
        queryCassandraTestRunner.enqueue("trigger");
        ...
        resultFlowFile.assertAttributeNotExists(QueryCassandra.FRAGMENT_ID);
        resultFlowFile.assertAttributeNotExists(QueryCassandra.FRAGMENT_INDEX);
        resultFlowFile.assertAttributeNotExists(QueryCassandra.FRAGMENT_COUNT);
    }
    ...
    private static int getRecordsCount() {
        SimpleStatement selectQuery = QueryBuilder.selectFrom(KEYSPACE, TABLE)
                .countAll()
                .build();
    ...
    private void dropRecords() {
        SimpleStatement truncateQuery = QueryBuilder.truncate(KEYSPACE, TABLE).build();

...
@CapabilityDescription("Execute provided Cassandra Query Language (CQL) select query on a Cassandra cluster. Query result "
...
public class QueryCassandra extends AbstractCassandraProcessor {
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        getLogger().info("DEBUG: NEW TIMEOUT LOGIC ACTIVE");

...
from nifiapi.flowfiletransformmultipleoutput import FlowFileTransformMultipleOutput, FlowFileTransformResult


class SplitLines(FlowFileTransformMultipleOutput):
    class Java:
        implements = ['org.apache.nifi.python.processor.FlowFileTransformMultipleOutput']

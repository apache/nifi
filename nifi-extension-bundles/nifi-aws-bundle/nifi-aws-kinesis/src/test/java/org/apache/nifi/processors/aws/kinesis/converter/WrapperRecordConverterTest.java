...
import static org.apache.nifi.processors.aws.kinesis.converter.KinesisRecordConverterTestUtil.INPUT_SCHEMA;
...
class WrapperRecordConverterTest {
    ...
    private static final RecordSchema EXPECTED_SCHEMA = new SimpleRecordSchema(List.of(
            ...
            new RecordField("value", RecordFieldType.RECORD.getRecordDataType(INPUT_SCHEMA))
    ));

    private static final WrapperRecordConverter CONVERTER = new WrapperRecordConverter();

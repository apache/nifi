...
public class WebIdentityCredentialsStrategy extends AbstractCredentialsStrategy implements CredentialsStrategy {
    ...
    @Override
    public com.amazonaws.auth.AWSCredentialsProvider getCredentialsProvider(final PropertyContext propertyContext) {
        throw new UnsupportedOperationException("AWS Java SDK v1 is not supported by Web Identity strategy");
    }

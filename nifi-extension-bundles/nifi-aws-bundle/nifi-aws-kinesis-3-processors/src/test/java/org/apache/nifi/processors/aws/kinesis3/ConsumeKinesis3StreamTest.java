...
import static org.apache.nifi.processors.aws.kinesis3.ConsumeKinesis3Stream.RECORD_READER;
...
class ConsumeKinesis3StreamTest {
    ...
    @BeforeEach
    void setUp() {
        testRunner = TestRunners.newTestRunner(ConsumeKinesis3Stream.class);
    }

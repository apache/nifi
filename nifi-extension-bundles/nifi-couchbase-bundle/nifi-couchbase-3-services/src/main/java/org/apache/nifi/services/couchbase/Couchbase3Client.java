...
public class Couchbase3Client implements CouchbaseClient {
    ...
    public Couchbase3Client(Collection collection, DocumentType documentType, PersistTo persistTo, ReplicateTo replicateTo) {
    ...
    @Override
    public long upsertDocument(String documentId, byte[] content) throws CouchbaseException {
        try {

...
public class PutCouchbaseKey extends AbstractCouchbaseProcessor {
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        try {
            ...
            switch (documentType) {
                case Json: {
                    doc = JsonObject.fromJson(new String(content, StandardCharsets.UTF_8));
            ...
            MutationResult result = openCollection(context, bucket).upsert(docId, doc,
            ...
            if (result == null) {
                throw new CouchbaseException("UPSERT result was null");
            }
            ...
            updatedAttrs.put(CouchbaseAttributes.Cas.key(), String.valueOf(result.cas()));

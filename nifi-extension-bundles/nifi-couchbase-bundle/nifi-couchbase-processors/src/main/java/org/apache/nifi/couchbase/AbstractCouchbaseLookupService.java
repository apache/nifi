...
import static org.apache.nifi.couchbase.CouchbaseConfigurationProperties.*;
...
public class AbstractCouchbaseLookupService extends AbstractControllerService {
    ...
    protected volatile String scopeName;
    ...
    public void onEnabled(final ConfigurationContext context) throws InitializationException {
        ...
        scopeName = context.getProperty(SCOPE_NAME).evaluateAttributeExpressions().getValue();

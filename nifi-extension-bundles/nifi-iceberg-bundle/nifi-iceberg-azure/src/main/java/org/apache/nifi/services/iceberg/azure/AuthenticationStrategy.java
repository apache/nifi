...
/**
 * Enumeration of supported Authentication Types for Azure Data Lake Storage access
 */
public enum AuthenticationStrategy implements DescribedValue {
    SHARED_ACCESS_SIGNATURE_TOKEN("Shared Access Signature Token", "Authentication using static Shared Access Signature Token"),

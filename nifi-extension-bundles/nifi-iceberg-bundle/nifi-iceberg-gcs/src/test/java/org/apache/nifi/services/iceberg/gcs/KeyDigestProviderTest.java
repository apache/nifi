...
class KeyDigestProviderTest {
    ...
    private static final String DIGEST_EXPECTED = "Kt9FTK2ulLNLyGIXrZ0ZGAUKQwOQNpffViNE76oTgp0=";

    @Test
    void testGetDigestEncoded() {
        final String digestEncoded = KeyDigestProvider.getDigestEncoded(INPUT_KEY);

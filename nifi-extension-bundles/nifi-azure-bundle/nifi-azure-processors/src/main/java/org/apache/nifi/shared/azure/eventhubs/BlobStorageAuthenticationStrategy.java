...
public enum BlobStorageAuthenticationStrategy implements DescribedValue {
    ...
    OAUTH2_CLIENT_CREDENTIALS("OAuth2", "Authenticate to Azure Blob Storage using an OAuth2 Access Token Provider backed by an Entra registered application.");

    private final String displayName;
    private final String description;

    BlobStorageAuthenticationStrategy(final String displayName, final String description) {

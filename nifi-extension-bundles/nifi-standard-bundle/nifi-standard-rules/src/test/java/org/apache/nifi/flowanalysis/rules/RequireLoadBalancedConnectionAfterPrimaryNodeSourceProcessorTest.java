...
public class RequireLoadBalancedConnectionAfterPrimaryNodeSourceProcessorTest extends AbstractFlowAnalysisRuleTest<RequireLoadBalancedConnectionAfterPrimaryNodeSourceProcessor> {
    ...
    @Override
    protected RequireLoadBalancedConnectionAfterPrimaryNodeSourceProcessor initializeRule() {
        return new RequireLoadBalancedConnectionAfterPrimaryNodeSourceProcessor();
    }
}
